...
for content_file in content_files:
    ...
    try:
        ...
        # Look for patterns like: const L102_DATA = { ... };
        # or export const L125_content = { ... };
        
        # Try to find the object definition
        match = re.search(r'(?:const|export const)\s+\w+\s*=\s*(\{[\s\S]*?\});', content)
        ...
        if match:
            ...
            print(f"Warning: Could not extract data from {content_file}")
