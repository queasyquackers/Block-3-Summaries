...
const LECTURES_DATA = [
  {
    id: 'l102',
    title: 'L102 - OMM: Lab 11 Prep Lecture - Lumbar Diagnosis, Lumbar Soft Tissue',
    module: 'OMM',
...
## Part 1: Lumbar Diagnosis and Biomechanics

### Visual Inspection & Landmarks
*   **Planes of Symmetry:** Inspect the patient for symmetry in the **Horizontal**, **Sagittal**, and **Coronal** planes.
*   **Plumb Line:** Compare left to right relative to the midline.
*   **Key Landmarks:**
    *   **T12:** Identified by the 12th rib.
    *   **L4:** Level of the **Iliac Crests**.
    *   **S2:** Level of the **PSIS** (Posterior Superior Iliac Spine).
...
## Part 2: Diagnosis of Somatic Dysfunction (TART)

### TART Criteria
1.  **T**issue Texture Change: Check for **Hypertonicity** (contracted, tight) or **Hypotonicity** (pliable, supple).
2.  **A**symmetry: Visual or palpatory (e.g., uneven TPs).
3.  **R**estriction of Motion: Named for the **freedom of motion**.
4.  **T**enderness: Subjective complaint from the patient.

### Diagnosing Type II Dysfunction
1.  **Static Palpation:** Identify the **Posterior Transverse Process**. This indicates the side of **Rotation**.
    *   *Example:* Right TP is posterior = Rotated Right.
2.  **Motion Testing (Flexion vs. Extension):**
    *   **Extension Test (Sphinx / "TV Watching Pose"):** If the asymmetry **improves** (TPs become more level), the diagnosis is **Extended** (ERS).
    *   **Flexion Test (Child's Pose):** If the asymmetry **improves**, the diagnosis is **Flexed** (FRS).
    *   *Mnemonic:* The diagnosis is named for the position where the dysfunction "disappears" (gets better).

-----

## Part 3: Soft Tissue Techniques

### Goals of Soft Tissue
*   Relax hypertonic muscles and fascia.
*   Improve circulation (Arterial supply, Venous/Lymph drainage).
*   **"We suffer from two things: the want of supply and a burden of dead deposits"** - A.T. Still.
*   Desensitize the **Stretch Reflex** (Muscle Spindle mechanism).

### Contraindications
*   **Absolute:** None (technically).
*   **Relative/Cautions:**
    *   Fractures, Open wounds.
    *   Infections, Abscesses.
    *   **DVT (Deep Vein Thrombosis):** Risk of embolism.
    *   Coagulopathy, Neoplasm.
    *   Recent surgical site.

### Techniques
1.  **Prone Traction (Two-handed, Lumbosacral):** Hands contact paravertebral muscles, applying a lateral/anterior stretch.
2.  **Prone Pressure with Counterleverage:** One hand on paraspinals, other on ASIS (pulling up) to create a twisting/stretching force.
3.  **Supine Extension:** Kneading/stretching the lumbar paraspinals with the patient supine.

-----

## Part 4: Lumbosacral Spring Test

*   **Objective:** Evaluate the lumbosacral junction (L5/S1) and sacral base.
*   **Procedure:**
    *   Patient prone.
    *   Physician places heel of hand over the lumbosacral junction.
    *   Apply a short, quick anterior "springing" force.
*   **Interpretation:**
    *   **Negative Test:** Good spring/compliance. (Normal or Flexed dysfunction).
    *   **Positive Test:** Resistance/Stiffness (Hard end feel). Indicates an **Extended** dysfunction (backward bending restriction) or sacral dysfunction.`,
    questions: `**1. A patient has a Type II somatic dysfunction at L3. The right transverse process is posterior. When the patient is placed in the Sphinx position (extension), the asymmetry becomes MORE pronounced. What is the diagnosis?**
...
**Rationale**: 
1.  **Rotation:** Right TP posterior = **Rotated Right** (Rr).
2.  **Type II:** Rotation and Sidebending are to the **Same** side -> **Sidebent Right** (Sr).
3.  **Flexion/Extension:** The asymmetry got **worse** in Extension. This means it does *not* like extension. It must like Flexion. Therefore, it is a **Flexed** dysfunction (FRS).
    *   Diagnosis: **L3 F Rr Sr**.
</details>

---

**2. Which of the following is considered a "Long Restrictor" muscle responsible for maintaining Type I group curves?**
...
**Answer: D (Erector Spinae)**

**Rationale**: **Type I (Group)** dysfunctions are maintained by long, multisegmental muscles like the **Erector Spinae** (Iliocostalis, Longissimus, Spinalis). Type II (Single) dysfunctions are maintained by short restrictors like Rotatores and Intertransversarii.
</details>

---

**3. During a structural exam, you perform the Lumbosacral Spring Test. You encounter a hard, resistant end-feel with no spring. This finding is most consistent with which diagnosis?**

A. Normal Lumbosacral Junction
B. L5 Flexed Dysfunction
C. L5 Extended Dysfunction
D. Anterior Sacral Torsion
E. Unilateral Sacral Flexion

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: C (L5 Extended Dysfunction)**

**Rationale**: A **Positive Spring Test** (resistance/stiffness) indicates that the segment or sacrum resists anterior motion. This is characteristic of an **Extended** dysfunction (where the segment is stuck in extension/backward bending and resists flexion/anterior springing) or a posterior sacral base (sacral extension). A Flexed dysfunction would spring easily.
</details>

---

**4. You are assessing a patient's lumbar spine and find TART changes from L1-L4. The transverse processes are posterior on the left at all these levels. The asymmetry remains unchanged in both flexion and extension. What is the correct notation?**
...
**Answer: B (L1-L4 N Sr Rl)**

**Rationale**:
1.  **Group/Neutral:** Multiple segments + no change in F/E = **Type I (Neutral)**.
2.  **Rotation:** Posterior TP on Left = **Rotated Left** (Rl).
3.  **Sidebending:** In Type I, S and R are **Opposite**. So **Sidebent Right** (Sr).
    *   Notation: **N Sr Rl** (or N Rl Sr). Option B matches standard notation.
</details>

---

**5. Which of the following soft tissue techniques involves the physician placing one hand on the lumbar paraspinals and the other on the ASIS to create a counter-leverage force?**

A. Prone Traction
B. Prone Pressure with Counterleverage
C. Supine Extension
D. Lateral Recumbent Kneading
E. Inhibition

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: B (Prone Pressure with Counterleverage)**
...
**Rationale**: **Prone Pressure with Counterleverage** involves pushing the paraspinal muscles medially/anteriorly while pulling up on the **ASIS** (Anterior Superior Iliac Spine) to create a twisting/stretching force through the lumbar region.
  ...
  {
    id: 'l103',
    title: 'L103 - Anatomy: Introduction to the Head and Neck',
    module: 'Anatomy',
    tags: 'Head & Neck, Skull, Cranial Nerves, Salivary Glands, Thyroid, Fontanelles',
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 05_Cranial_Nerves', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 04_Cranial_Nerves_-_Part_1'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 05_Cranial_Nerves_-_Part_2'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'Pathoma', 'chapter': '15_Endocrine > 03_Thyroid_Gland'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 02_Hyperthyroidism'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 03_Upper_Extremity_Nerves'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 03_Hypothyroidism'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 05_Parathyroid_Gland_Disorders'}, {'resource': 'FirstAid', 'chapter': '08_Endocrine > 04_Pathology > 06_Hypothyroidism'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 01_Propylthiouracil,_methimazole,_levothyroxine'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 01_Hypothyroidism:_Overview_&_Hashimotos_Thyroiditis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 03_Hyperthyroidism:_Overview_&_Graves_Disease'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 04_Thyroid_Nodules_&_Cancer'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves > CN_03_Oculomotor_Nerve'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Headache > Idiopathic_Intracranial_Hypertension'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Introduction_to_the_Respiratory_System > Pulmonology_System_Function,_Anatomy,_and_Histology'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Axilla > Clinical_-_Lesion_of_Upper_Limb_Nerves'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 03_Teriparatide,_vitamin_D,_cinacalcet,_sevelamer'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 04_Glucocorticoids'}, {'resource': 'Pathoma', 'chapter': '15_Endocrine > 08_Parathyroid_Gland'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 02_Bisphosphonates,_raloxifene,_denosumab,_calcitonin'}, {'resource': 'Pathoma', 'chapter': '10_GI > 02_Salivary_Gland'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 09_Tension_Headache'}, {'resource': 'Pathoma', 'chapter': '16_Breast > 01_Introduction'}]},
    summary: `

**Lecturer:** Aki Watanabe, Ph.D.
**Session:** Lecture #103

-----

## Part 1: Head & Neck Architecture
...
*   **Axis (C2):** Has the **Dens** (Odontoid process). Acts as a pivot for C1 (Atlanto-axial joint) -> Allows "No" motion (Rotation).

### Fontanelles (Soft Spots)
*   **Function:** Allow skull deformation during birth and brain growth after birth.
*   **Major Fontanelles:**
...
## Part 2: Special Senses & Organs

### Salivary Glands
1.  **Parotid Gland:** Anterior to ear. Watery saliva (Parasympathetic).
2.  **Submandibular Gland:** Inferior to mandible. Mixed secretions. Duct opens at sublingual caruncle.
3.  **Sublingual Gland:** Floor of mouth. Mucous secretions. Multiple small ducts.
...
## Part 3: Cranial Nerves (Overview)

| # | Name | Exit | Function (Key) |
| :--- | :--- | :--- | :--- |
| **I** | **Olfactory** | Cribriform Plate | Smell (SVA). |
| **II** | **Optic** | Optic Canal | Vision (SSA). |
| **III** | **Oculomotor** | Sup. Orbital Fissure | Eye movement (SR, IR, MR, IO), Eyelid elevation (LPS), Pupil constriction/Accommodation (P). |
| **IV** | **Trochlear** | Sup. Orbital Fissure | Eye movement (Superior Oblique - "Down & Out"). |
| **V** | **Trigeminal** | V1: SOF, V2: Rotundum, V3: Ovale | Sensation to face (V1, V2, V3); Muscles of Mastication (V3). |
| **VI** | **Abducens** | Sup. Orbital Fissure | Eye movement (Lateral Rectus - Abduction). |
| **VII** | **Facial** | Int. Acoustic Meatus -> Stylomastoid Foramen | Muscles of Facial Expression, Taste (Ant 2/3), Salivation (Submandibular/Sublingual), Lacrimation. |
| **VIII** | **Vestibulocochlear** | Int. Acoustic Meatus | Hearing and Balance (SSA). |
| **IX** | **Glossopharyngeal** | Jugular Foramen | Taste/Sensation (Post 1/3), Swallowing (Stylopharyngeus), Parotid gland (Salivation). |
| **X** | **Vagus** | Jugular Foramen | Palate/Pharynx/Larynx muscles, Parasympathetics to Thorax/Abdomen, Visceral sensation. |
...
C. Anterolateral (Sphenoidal) Fontanelle
D. Posterolateral (Mastoid) Fontanelle
E. Metopic Suture

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: B (Anterior Fontanelle)**

**Rationale**: The **Anterior Fontanelle** (bregma) is the largest soft spot, located between the frontal and parietal bones. It typically closes between **18-24 months** of age. The posterior fontanelle closes much earlier (2-3 months).
</details>

---

**2. A patient presents with a "runny nose" while crying. This phenomenon is explained by the drainage of tears from the lacrimal sac into the nasal cavity via which structure?**
...
**Rationale**: Tears drain from the eye surface -> Puncta -> Canaliculi -> Lacrimal Sac -> **Nasolacrimal Duct** -> Inferior Meatus of the nasal cavity. This connection causes rhinorrhea during crying.
</details>

---

**3. Which cranial nerve provides motor innervation to the SCM and Trapezius muscles, allowing for head turning and shoulder shrugging?**

A. CN IX (Glossopharyngeal)
B. CN X (Vagus)
C. CN XI (Accessory)
D. CN XII (Hypoglossal)
E. C1-C2 Spinal Nerves

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: C (CN XI (Accessory))**

**Rationale**: **CN XI (Spinal Accessory Nerve)** innervates the **Sternocleidomastoid (SCM)** and **Trapezius** muscles. Testing involves asking the patient to shrug their shoulders (Trapezius) and turn their head against resistance (SCM).
</details>

---

**4. A patient presents with an enlarged thyroid gland (goiter). Which nerve is most at risk of compression by this enlargement, potentially causing hoarseness?**
...
**Rationale**: The **Recurrent Laryngeal Nerve** (a branch of the Vagus) ascends in the tracheoesophageal groove, just posterior to the thyroid gland. Goiters or thyroid surgery can compress or damage this nerve, leading to vocal cord paralysis and hoarseness.
</details>

---

**5. Which salivary gland is located anterior to the ear and receives parasympathetic innervation from CN IX (Glossopharyngeal)?**
...
**Rationale**: The **Parotid Gland** is the largest salivary gland, located anterior to the ear. It receives secretomotor (parasympathetic) innervation from **CN IX** (via the Otic Ganglion and Auriculotemporal nerve). The Submandibular and Sublingual glands are innervated by CN VII.
</details>`,
    glossary: [
      { term: "Fontanelle", definition: "Membranous gaps between cranial bones in infants ('soft spots')." },
      { term: "Neurocranium", definition: "Bones enclosing the brain (Frontal, Parietal, Temporal, Occipital, Sphenoid, Ethmoid)." },
      { term: "Viscerocranium", definition: "Facial skeleton bones." },
      { term: "Goiter", definition: "Abnormal enlargement of the thyroid gland." },
      { term: "Nasolacrimal Duct", definition: "Duct draining tears from the lacrimal sac to the nasal cavity." },
      { term: "Atlas (C1)", definition: "First cervical vertebra; allows 'Yes' motion." },
      { term: "Axis (C2)", definition: "Second cervical vertebra; has Dens; allows 'No' motion." }
    ]
  },
  {
    id: 'l104',
    title: 'L104 - Anatomy: Head & Neck Embryology',
    module: 'Anatomy',
    tags: 'Embryology, Pharyngeal Arches, Clefts, Pouches, Neural Crest, Thyroid, Tongue',
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '09_GI > 01_Anatomy > 01_Gastrointestinal_Embryology', 'alternatives': [{'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'Physeo', 'chapter': '01_Embryology > 03_Pulmonology > 01_Respiratory_Embryology'}, {'resource': 'Physeo', 'chapter': '01_Embryology > 07_Neuro > 01_Neurological_Development_&_Neural_Tube_Defects'}, {'resource': 'Physeo', 'chapter': '01_Embryology > 04_Nephrology > 01_Normal_Renal_Development'}, {'resource': 'Physeo', 'chapter': '01_Embryology > 04_Nephrology > 02_Renal_Embryo_Pathology'}, {'resource': 'Physeo', 'chapter': '01_Embryology > 01_Repro > 08_1st_&_2nd_Pharyngeal_Arches'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Anatomy_&_Embryology > Developmental_Anomalies'}, {'resource': 'Pathoma', 'chapter': '15_Endocrine > 03_Thyroid_Gland'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Anatomy_&_Embryology > Anatomy'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 05_Parathyroid_Gland_Disorders'}, {'resource': 'FirstAid', 'chapter': '08_Endocrine > 04_Pathology > 06_Hypothyroidism'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 01_Propylthiouracil,_methimazole,_levothyroxine'}, {'resource': 'Bootcamp', 'chapter': 'Embryology > Embryonic_Period:_Weeks_3-8 > Amniotic_&_Chorionic_Development'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 01_Embryology > 04_Neural_Tube_Defects'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 01_Hypothyroidism:_Overview_&_Hashimotos_Thyroiditis'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 03_Hyperthyroidism:_Overview_&_Graves_Disease'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 04_Thyroid_Nodules_&_Cancer'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 40_Spinal_Tract_Anatomy_&_Functions'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'FirstAid', 'chapter': '16_Respiratory > 01_Embryology > 05_Neonatal_Respiratory_Distress_Syndrome'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Embryology > Embryologic_Cranial_Defects_and_Spinal_Defects'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 04_Congenital_&_Neurocutaneous > 01_Neural_Tube_Defects,_Holoprosencephaly,_Chiari_Malformation_&_Syringomyelia'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 03_Teriparatide,_vitamin_D,_cinacalcet,_sevelamer'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 04_Glucocorticoids'}, {'resource': 'Pathoma', 'chapter': '15_Endocrine > 08_Parathyroid_Gland'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 02_Bisphosphonates,_raloxifene,_denosumab,_calcitonin'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 09_Tension_Headache'}]},
    summary: `
...
## Part 1: Segmented Structures (Pharyngeal Apparatus)

The Pharyngeal Apparatus consists of **Arches** (Mesoderm/Neural Crest), **Clefts** (Ectoderm), **Pouches** (Endoderm), and **Membranes**.
...
*   **Arch 2 (Hyoid):**
    ...
    *   **Bone/Cartilage:** Stapes, Styloid process, Upper Hyoid.
*   **Arch 3:**
    *   **Nerve:** CN IX (Glossopharyngeal).
    *   **Muscles:** Stylopharyngeus.
    *   **Bone/Cartilage:** Lower Hyoid.
*   **Arch 4 & 6:**
    *   **Nerve:** CN X (Vagus) - Superior Laryngeal (Arch 4) & Recurrent Laryngeal (Arch 6).
    *   **Muscles:** Pharyngeal constrictors, Cricothyroid, Levator Veli Palatini (Arch 4); Intrinsic Laryngeal muscles (Arch 6).
    *   **Bone/Cartilage:** Laryngeal cartilages (Thyroid, Cricoid, Arytenoid).

### Pharyngeal Pouches (Endoderm)
*   **Pouch 1:** Auditory (Eustachian) tube, Tympanic cavity.
...
## Part 2: Rebels (Tongue, Thyroid, Placodes)

### Tongue Development
*   **Anterior 2/3:** Arch 1 (Sensation: V3) & Arch 2 (Taste: VII).
*   **Posterior 1/3:** Arch 3 (Sensation/Taste: IX).
*   **Root/Epiglottis:** Arch 4 (Sensation/Taste: X).
...
*   **Lens Placode:** Lens of eye (CN II association).
*   **Otic Placode:** Inner ear (Vestibule/Cochlea) (CN VIII).

-----

## Part 3: Germ Layers & Neural Crest

### Neural Crest Cells (NCC)
*   **"Ectoderm that acts like Mesoderm"** (Ectomesenchyme).
*   **Derivatives:**
    *   **Bone/Cartilage:** Facial bones (Viscerocranium), Middle ear ossicles, Hyoid.
...
*   **Mesoderm:** Muscles (somitomeres), Arteries, Laryngeal cartilages.
*   **Endoderm:** Glandular tissues (Thyroid, Parathyroid, Thymus), Mucosa of GI/Respiratory tracts.`,
    questions: `**1. A 4-year-old child presents with a midline neck mass that moves upward when the child sticks out their tongue. This mass is most likely a remnant of which embryological structure?**
...
**Rationale**: A **Thyroglossal Duct Cyst** presents as a **midline** neck mass. It moves with tongue protrusion because the duct connects the thyroid to the **Foramen Cecum** at the base of the tongue. Branchial cleft cysts are lateral.
</details>

---

**2. Which pharyngeal arch gives rise to the muscles of facial expression and the stapes bone?**
...
**Rationale**: **Arch 2 (Hyoid Arch)** is innervated by **CN VII (Facial)**. It forms the muscles of facial expression, stapedius, stylohyoid, and posterior digastric, as well as the **Stapes** and styloid process.
</details>

---

**3. A newborn is diagnosed with DiGeorge Syndrome (22q11 deletion). Which of the following structures are likely to be underdeveloped due to a defect in the 3rd and 4th Pharyngeal Pouches?**

A. Thyroid and Parathyroid
B. Thymus and Inferior Parathyroid
C. Tonsils and Thymus
D. Middle Ear and Eustachian Tube
E. Superior and Inferior Parathyroid

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: B (Thymus and Inferior Parathyroid)**

**Rationale**: The **3rd Pouch** forms the **Thymus** and **Inferior Parathyroid** glands. The 4th pouch forms the Superior Parathyroid. DiGeorge syndrome affects these pouches, leading to thymic aplasia (immune deficiency) and hypocalcemia.
</details>

---

**4. The anterior two-thirds of the tongue receives general somatic sensation (touch/pain) from which cranial nerve?**
...
**Rationale**: The anterior 2/3 of the tongue comes from Arch 1. Sensation is via **CN V3 (Lingual nerve)**. Taste is via **CN VII (Chorda Tympani)** (Arch 2). Posterior 1/3 sensation/taste is CN IX (Arch 3). Motor is CN XII.
</details>

---

**5. Treacher Collins syndrome involves craniofacial deformities such as micrognathia and malformed ears. This condition is primarily due to a defect in the migration of which cell type?**
...
**Rationale**: **Treacher Collins Syndrome** is a result of faulty migration/proliferation of **Neural Crest Cells** in the 1st and 2nd Pharyngeal Arches, leading to underdevelopment of facial bones (mandible, zygoma) and ears.
</details>`,
    glossary: [
      { term: "Pharyngeal Arch", definition: "Mesodermal/Neural Crest core lined by ectoderm/endoderm; forms head/neck structures." },
      { term: "Pharyngeal Pouch", definition: "Endodermal outpocketing between arches." },
      { term: "Thyroglossal Duct", definition: "Temporary connection between developing thyroid and tongue base." },
      { term: "Neural Crest Cells", definition: "Migratory ectodermal cells forming facial bones, ganglia, melanocytes, etc." },
      { term: "Placode", definition: "Ectodermal thickening forming special sense organs (Lens, Otic, Nasal)." },
      { term: "Somitomeres", definition: "Segmented mesodermal units in the head region forming muscles." }
    ]
  },
  {
    id: 'l105',
    title: 'L105 - Anatomy: Paths and Functions of Somatic Afferents and Efferents of the Head and Neck',
    module: 'Anatomy',
    tags: 'Cranial Nerves, CN III, CN IV, CN V, CN VI, CN VII, CN IX, CN X, CN XI, CN XII',
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 05_Cranial_Nerves', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 04_Cranial_Nerves_-_Part_1'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 05_Cranial_Nerves_-_Part_2'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 40_Spinal_Tract_Anatomy_&_Functions'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 03_Upper_Extremity_Nerves'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > External_Examination_of_the_Brain_+_Skull > Cranial_Nerve_Functions:_CN_V,_CN_VII,_&_CN_VIII'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves > CN_03_Oculomotor_Nerve'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 04_GI > 05_Layers_of_the_Intestinal_Wall'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Cranial_Nerves_7-12 > Cranial_Nerve_VII'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Axilla > Clinical_-_Lesion_of_Upper_Limb_Nerves'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Cranial_Nerves_1-6 > Cranial_Nerve_III'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 08_MSK > 02_Lower_Trunk_&_the_Median_&_Ulnar_Nerves'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 01_Intracranial_Hypertension_(ICH)'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 04_Pediatric_CNS_Tumors'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 02_Hydrocephalus'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 04_Antiarrhythmics > 03_Class_III'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 08_Glycogen_Storage > 03_Cori_Disease_(Type_III)'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 09_Tension_Headache'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 10_Heme > Glycoprotein_IIb/IIIa_Inhibitors'}]},
    summary: `
...
## Part 1: The Eye Movers (CN III, IV, VI)

### CN III: Oculomotor Nerve
*   **Exit:** Superior Orbital Fissure (SOF).
*   **Divisions:**
...
## Part 2: The Big Two (CN V, VII)

### CN V: Trigeminal Nerve (Sensory + Motor V3)
*   **Ganglion:** Trigeminal (Semilunar) Ganglion.
*   **V1 Ophthalmic (Sensory):** Exits SOF.
    *   **Frontal:** Supraorbital (forehead), Supratrochlear (medial brow).
    *   **Nasociliary:** Ethmoidal, Infratrochlear, Long Ciliary (Sensory to eye + Sympathetics).
    *   **Lacrimal:** Sensory to lacrimal gland.
*   **V2 Maxillary (Sensory):** Exits Foramen Rotundum -> Pterygopalatine Fossa.
    *   **Infraorbital:** Lower eyelid, upper lip.
    *   **Zygomatic:** Zygomaticofacial, Zygomaticotemporal.
    *   **Palatine:** Greater/Lesser Palatine (Hard/Soft Palate).
*   **V3 Mandibular (Mixed):** Exits Foramen Ovale.
...
*   **Branches:**
    *   **Greater Petrosal:** Parasympathetics to Lacrimal/Nasal glands.
...
## Part 3: The Rest (CN IX, X, XI, XII)

### CN IX: Glossopharyngeal Nerve
*   **Exit:** Jugular Foramen.
*   **Function:**
    *   **Sensory:** Pharynx, Post 1/3 Tongue (Taste/Sensation), Middle Ear.
...
*   **Exit:** Jugular Foramen.
*   **Branches:**
    *   **Pharyngeal:** Motor to Pharynx/Soft Palate (except Tensor Veli Palatini).
    *   **Superior Laryngeal:**
...
**Answer: C (Abducens CN VI)**

**Rationale**: The **Abducens Nerve (CN VI)** innervates the **Lateral Rectus** muscle, which is responsible for **abducting** the eye. A lesion leads to unopposed medial pull (esotropia) and inability to abduct.
</details>

---

**2. A patient complains of numbness over their forehead and the bridge of their nose. Which branch of the Trigeminal nerve is responsible for sensation in this region?**

A. Infraorbital Nerve (V2)
B. Supraorbital Nerve (V1)
C. Mental Nerve (V3)
D. Zygomaticofacial Nerve (V2)
E. Auriculotemporal Nerve (V3)

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: B (Supraorbital Nerve (V1))**

**Rationale**: The **Supraorbital Nerve** is a terminal branch of the **Frontal Nerve** (from **V1 Ophthalmic**). It supplies the skin of the forehead, scalp, and upper eyelid. The Infratrochlear (also V1) supplies the bridge of the nose.
</details>

---

**3. During a thyroidectomy, a surgeon accidentally damages a nerve running in the tracheoesophageal groove. Post-operatively, the patient has a hoarse voice. Which muscle is most likely paralyzed?**
...
**Rationale**: The nerve in the tracheoesophageal groove is the **Recurrent Laryngeal Nerve**. It innervates all intrinsic laryngeal muscles *except* the Cricothyroid. The **Posterior Cricoarytenoid** (the only abductor of vocal folds) would be paralyzed, causing hoarseness or airway obstruction. Cricothyroid is innervated by the External Laryngeal Nerve.
</details>

---

**4. A patient presents with right-sided facial paralysis involving the forehead, eye closure, and mouth. They also report hyperacusis (sensitivity to loud sounds) in the right ear. Where is the lesion most likely located?**
...
**Answer: B (Internal Acoustic Meatus)**

**Rationale**: The symptoms involve the **Facial Nerve (CN VII)**.
*   **Facial Paralysis:** Motor branch.
*   **Hyperacusis:** Paralysis of the **Stapedius** muscle (nerve to stapedius branches off *within* the facial canal).
*   A lesion at the **Stylomastoid Foramen** would cause facial paralysis but *spare* the stapedius (nerve branches off before exit).
*   A lesion in the **Internal Acoustic Meatus** or proximal facial canal would affect both.
</details>

---

**5. When asking a patient to stick out their tongue, it deviates to the left. Which nerve is damaged?**
...
**Answer: B (Left CN XII)**

**Rationale**: The **Hypoglossal Nerve (CN XII)** innervates the **Genioglossus** muscle, which protrudes the tongue. If one side is weak, the healthy side pushes the tongue *towards* the paralyzed side. Deviation to the **left** implies a **Left CN XII** lesion ("Lick your wounds").
</details>`,
    glossary: [
      { term: "Anisocoria", definition: "Unequal pupil size; often a sign of CN III parasympathetic lesion." },
      { term: "Ptosis", definition: "Drooping of the upper eyelid (Levator Palpebrae Superioris weakness)." },
      { term: "Torticollis", definition: "Abnormal neck twisting; can be due to SCM spasm or CN XI lesion." },
      { term: "Genioglossus", definition: "Major tongue protruder muscle; innervated by CN XII." },
      { term: "Recurrent Laryngeal Nerve", definition: "Branch of Vagus; loops under aorta/subclavian; innervates laryngeal muscles." },
      { term: "Cavernous Sinus", definition: "Venous sinus containing CN III, IV, V1, V2, VI and Internal Carotid Artery." }
    ]
  },
  {
    id: 'l106',
    title: 'L106 - DPR: Health Disparities: Closing the Gap through Cultural Competency',
    module: 'DPR',
    tags: 'Health Disparities, Cultural Competency, Cultural Humility, Social Determinants of Health, Health Belief Model',
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 01_Propylthiouracil,_methimazole,_levothyroxine'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 01_Heart_Failure_Drugs > 02_ACE_inhibitors,_ARBs,_Aliskiren'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 03_Thyroid,_Parathyroid_&_Adrenal > 03_Teriparatide,_vitamin_D,_cinacalcet,_sevelamer'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 04_Antiarrhythmics > 01_Class_I_A-C'}, {'resource': 'B&B', 'chapter': '19_Renal > 03_Electrolytes > 01_Electrolytes'}, {'resource': 'B&B', 'chapter': '19_Renal > 01_Intro > 06_Renal_Endocrinology'}, {'resource': 'B&B', 'chapter': '19_Renal > 01_Intro > 05_Nephron_Physiology'}, {'resource': 'B&B', 'chapter': '19_Renal > 05_Other > 03_Diuretics'}, {'resource': 'Physeo', 'chapter': '05_Biochem > 05_Metabolism > 18_Purines_&_Pyrimidines'}, {'resource': 'Physeo', 'chapter': '05_Biochem > 05_Metabolism > 16_Lipid_Transport'}, {'resource': 'B&B', 'chapter': '08_Endocrinology > 02_Adrenals > 03_Adrenal_Disorders'}, {'resource': 'Physeo', 'chapter': '05_Biochem > 05_Metabolism > 28_Nutrition'}, {'resource': 'Pathoma', 'chapter': '12_Renal > 02_Acute_Renal_Failure'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 02_Glomerulopathy > 02_Nephritic_Syndrome'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 08_Renal_Pathology > 01_Acute_Kidney_Injury'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 04_Acid/Base_Disorders'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 01_Osmolality_&_Sodium_Disorders'}, {'resource': 'Pathoma', 'chapter': '15_Endocrine > 10_Adrenal_Cortex'}, {'resource': 'Physeo', 'chapter': '05_Biochem > 05_Metabolism > 07_Glycogen'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 02_Adrenal_Disorders > 04_Cushings_Syndrome'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 03_Congenital_&_Chronic_Kidney_Disease > 01_Congenital_&_Cystic_Kidney_Disease'}, {'resource': 'Pathoma', 'chapter': '12_Renal > 03_Nephrotic_Syndrome'}, {'resource': 'Pathoma', 'chapter': '12_Renal > 04_Nephritic_Syndrome'}, {'resource': 'Pathoma', 'chapter': '12_Renal > 01_Congenital'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 17_Renal > ACE_Inhibitors'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 02_Pathways > 10_Purine_Excretion'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 17_Renal > Acetazolamide'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 03_Lipids > 01_Chylomicron_Metabolism'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 17_Renal > Loop_Diuretics_(Furosemide,_Bumetanide,_Torsemide)'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Fluid_&_Filtration_Physiology > Clearance_Renal_Plasma_and_Blood_Flow'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Intestinal_Pathology > Infectious_Malabsorption'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}]},
    summary: `

**Lecturer:** B. Laurent, D.O.
**Session:** Lecture #106

-----

## Part 1: Defining Health Disparities

### Definition
*   **Health Disparities:** Differences in the incidence, prevalence, mortality, and burden of disease and other adverse health conditions that exist among specific population groups.
*   **Key Factors:** Socioeconomic status, education, age, race, ethnicity, geography, disability, gender, ****** orientation.
...
2.  **Maternal & Child Health:**
    ...
    *   **Infant Mortality:** Highest in Black populations (10.8 per 1k).
3.  **Geography:**
    *   **"Where you live matters."**
    *   **Mississippi Delta:** Region with significant health challenges (where NYIT-COM Arkansas is located).
    *   **NYC Subway Study:** Life expectancy can vary by ~10 years depending on the subway stop (e.g., Lincoln Center vs. Harlem).

-----

## Part 2: Cultural Competency vs. Cultural Humility

### Cultural Competency
*   **Definition:** Services that are respectful of and responsive to the health beliefs, practices, and cultural/linguistic needs of diverse patients.
*   **Critique:** Can be viewed as a "technical skill" to be mastered, potentially reinforcing stereotypes ("Cultural Competability").

### Cultural Humility
*   **Definition:** A lifelong process of self-reflection and personal critique.
*   **Key Aspect:** It is a **posture** of learning, not a destination. You cannot "master" every culture.

### The Process of Cultural Competency (Campinha-Bacote Model)
A Venn diagram of 5 overlapping elements:
1.  **Cultural Awareness:** Self-examination of one's own biases and prejudices. **Suspend Judgment.**
2.  **Cultural Knowledge:** Seeking sound educational foundation about diverse groups (understanding prevalence, treatment efficacy).
3.  **Cultural Skill:** Ability to collect relevant cultural data and perform culturally sensitive assessments.
4.  **Cultural Encounters:** Directly engaging with people from different backgrounds.
5.  **Cultural Desire:** The **motivation** to *want* to engage (vs. *having* to).

-----

## Part 3: Culture and Health Outcomes

### Impact of Lack of Competency
*   Barriers to care (mistrust, fear of disrespect).
*   Poor adherence to medical advice.
*   Missed diagnoses (due to lack of knowledge of prevalence).
*   Harmful drug interactions (not asking about traditional remedies).

### Health Belief Model (Dimensions)
Understanding how a patient views their illness:
1.  **Perceived Susceptibility:** Do they think they can get sick?
2.  **Perceived Seriousness:** How severe do they think it is?
3.  **Perceived Benefits:** Do they believe the treatment will help?
4.  **Perceived Barriers:** What stops them? (Cost, stigma, shame).
5.  **Self-Efficacy:** Do they believe they can change their situation?

### Case Study: 33yo Pakistani Woman
*   **Presentation:** Vaginal discharge (Yeast infection).
*   **Underlying Issue:** Uncontrolled Diabetes (stopped insulin).
*   **Cultural Context:**
    *   **Shame/Isolation:** Diabetes meant she couldn't eat family meals (isolation).
    *   **Barrier:** Felt shame in using insulin.
    *   **Outcome:** Understanding her "lived experience" allowed for better coaching than just prescribing medication.

-----

## Part 4: Cultural Proficiency Continuum

A spectrum of attitudes and practices:
1.  **Cultural Destructiveness:** Attitudes/policies that eliminate cultures (e.g., Genocide).
2.  **Cultural Incapacity:** Devaluing other cultures; belief in superiority of dominant group.
3.  **Cultural Blindness:** "I don't see color." Ignores the lived experience and distinct needs of different groups.
4.  **Cultural Pre-Competence:** Awareness of limitations, desire to improve, but imperfect responses.
5.  **Cultural Competence:** Acceptance and respect for difference; ongoing self-assessment.
6.  **Cultural Proficiency:** Holding culture in high esteem; advocating for systems change.`,
    questions: `**1. Which of the following best describes "Cultural Humility" as opposed to "Cultural Competency"?**

A. Mastering a specific set of facts about different cultures.
B. A lifelong commitment to self-evaluation and personal critique.
C. Achieving a state where one is "blind" to cultural differences.
D. Learning to speak the language of the patient population.
E. Knowing the specific disease prevalence for every ethnic group.

<details>
<summary><strong>Click to Reveal Answer</strong></summary>

**Answer: B (A lifelong commitment to self-evaluation and personal critique)**

**Rationale**: **Cultural Humility** is defined as a dynamic, lifelong process focusing on self-reflection and critique, acknowledging that one cannot "master" another's culture. Cultural Competency is often critiqued for implying a finite skill set or checklist.
</details>

---

**2. According to the lecture, which population group in the US had the highest rate of pregnancy-related mortality (deaths per 100,000 births)?**
...
**Answer: D (Black / African American)**

**Rationale**: The data presented shows the **Black population** has the highest pregnancy-related mortality rate (40.8), followed by American Indian/Alaskan Natives (29.7).
</details>

---

**3. A physician claims, "I treat all my patients exactly the same, regardless of their race or background. I don't see color." On the Cultural Proficiency Continuum, this attitude is best described as:**

A. Cultural Destructiveness
B. Cultural Incapacity
C. Cultural Blindness
D. Cultural Pre-Competence
E. Cultural Proficiency
...
**Rationale**: **Cultural Blindness** is the belief that culture makes no difference and that all people are the same. While often well-intentioned, it is harmful because it ignores the unique "lived experiences" and needs of different groups, potentially leading to unmet health needs.
</details>

---

**4. In the Campinha-Bacote model of cultural competency, which element refers to the "motivation" of the healthcare professional to want to engage in the process?**
...
**Answer: E (Cultural Desire)**

**Rationale**: **Cultural Desire** is the motivation of the healthcare professional to *want* to, rather than *have* to, engage in the process of becoming culturally aware and seeking cultural encounters.
</details>

---

**5. A patient with diabetes is non-compliant with their insulin regimen. Upon further discussion, you learn that they feel isolated because they cannot eat the same meals as their family, and this "shame" prevents them from managing their condition. Which dimension of the Health Belief Model does this "shame and isolation" best represent?**
...
**Answer: D (Perceived Barriers)**

**Rationale**: The patient's feelings of **shame** and **isolation** act as **Perceived Barriers** to adherence. They view the treatment (insulin/diet) as creating a social/emotional hurdle that outweighs the health benefit in their current mindset.
</details>`,
    glossary: [
      { term: "Health Disparities", definition: "Differences in health outcomes (incidence, prevalence, mortality) among specific population groups." },
      { term: "Cultural Humility", definition: "Lifelong process of self-reflection and critique regarding cultural interactions." },
      { term: "Cultural Blindness", definition: "The belief that culture makes no difference and all people are the same; ignores lived experiences." },
      { term: "Health Belief Model", definition: "Psychological model attempting to explain and predict health behaviors (Susceptibility, Seriousness, Benefits, Barriers, Self-Efficacy)." },
      { term: "Cultural Desire", definition: "The motivation to want to engage in the process of cultural competency." }
    ]
  },
  {
    id: 'l107_108',
    highYieldPdf: 'L107L108_HighYield_Render.pdf',
...
*   **Physiologic (Functional) Antagonism:** Two drugs act on *different* receptors to produce opposite effects.
    *   *Example:* Methacholine (bronchoconstriction via muscarinic - used in **Bronchoprovocation Test** for asthma) vs. Albuterol (bronchodilation via Beta-2).
...
*   **Mechanisms of Permeation:**
    1.  **Passive Diffusion:** Most common. Driven by concentration gradient (high to low). Depends on lipid solubility (lipid-water partition coefficient).
        *   *Fick's Law:* Rate ∝ (Area × Permeability × Concentration Gradient) / Thickness.
...
*   **Weak Acids (HA ⇌ H$^+$ + A$^-$):**
    *   Protonated form (HA) is non-ionized → crosses membrane.
    *   Accumulate in basic environments (ion trapping).
*   **Weak Bases (BH$^+$ ⇌ H$^+$ + B):**
    *   Protonated form (BH$^+$) is ionized → does NOT cross.
    *   Non-protonated form (B) crosses.
    *   Accumulate in acidic environments.
*   **Clinical Application (Ion Trapping):**
    *   **Salicylate (Aspirin) Toxicity:** Weak acid. Alkalinize urine (increase pH) with bicarbonate → traps drug in urine (A$^-$ form) → increases excretion.
...
*   **First-Pass Effect:** Metabolism of drug by gut wall and liver *before* reaching systemic circulation. Reduces bioavailability. (e.g., **Nitroglycerin** is given sublingually to bypass this).
...
*   **Protein Binding:**
    ...
    *   *Clinical Significance:* Only **free** (unbound) drug is active, metabolized, and excreted. Hypoalbuminemia → increased free drug → potential toxicity.
*   **Redistribution:**
    *   Mechanism for termination of action of highly lipid-soluble drugs (e.g., Thiopental).
    *   Rapidly enters highly perfused organs (Brain) → Effect.
    *   Redistributes to less perfused tissues (Muscle, Fat) → Termination of effect (plasma levels drop).
...
*   **Outcome:** Highly polar, inactive conjugates → Excreted in urine/bile.
*   **Note:** Phase II can occur without Phase I.

### Factors Affecting Metabolism
1.  **Enzyme Induction:**
    *   Increased enzyme synthesis → Increased metabolism → Decreased drug effect.
    *   *Examples:* Rifampin, Carbamazepine, St. John's Wort.
2.  **Enzyme Inhibition:**
    *   Decreased enzyme activity → Decreased metabolism → Increased drug levels (Toxicity).
...
*   **Biliary Excretion & Enterohepatic Circulation:**
    *   Drug/Metabolite secreted into bile → Intestine.
    *   Gut bacteria cleave conjugate → Free drug reabsorbed → Prolongs duration of action.

### Special Populations
*   **Neonates:** Immature liver/kidney function → Reduced metabolism/excretion → Toxicity risk (e.g., Gray Baby Syndrome - Chloramphenicol).
...
`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 05_Cranial_Nerves', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 04_Cranial_Nerves_-_Part_1'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 05_Cranial_Nerves_-_Part_2'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 40_Spinal_Tract_Anatomy_&_Functions'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 05_Ophthalmology > 01_Normal_Eye_Anatomy'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 20_Cerebellum'}, {'resource': 'Pathoma', 'chapter': '08_Cardiac > 01_Ischemic_Heart_Disease'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 02_Cardio > 11_Heart_Sounds_-_Part_1'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 02_Cardio > 10_Baroreceptor_Reflex_&_Special_Circulations'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Axilla > Clinical_-_Lesion_of_Upper_Limb_Nerves'}, {'resource': 'SketchyPath', 'chapter': '01_Cardiac > 05_Congenital_Heart_Disease > 01_Left-to-Right_Shunts'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 01_Heart_Failure_Drugs > 02_ACE_inhibitors,_ARBs,_Aliskiren'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 01_Intracranial_Hypertension_(ICH)'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 04_Pediatric_CNS_Tumors'}, {'resource': 'SketchyPath', 'chapter': '01_Cardiac > 04_Valvular_Disorders > 01_Mitral_Stenosis,_Acute_Rheumatic_Fever_&_Rheumatic_Heart_Disease'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > External_Examination_of_the_Brain_+_Skull > Cranial_Nerve_Functions:_CN_V,_CN_VII,_&_CN_VIII'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 01_Cyclophosphamide,_ifosfamide,_busulfan,_nitrosoureas_(carmustine,_lomustine,_streptozocin)'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 03_Bleomycin,_doxorubicin,_daunorubicin,_actinomycin_D'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 01_Cyclophosphamide,_ifosfamide,_busulfan,_nitrosoureas_(carmustine,_lomustine,_streptozocin) > zanki_extra'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 01_Heart_Failure_Drugs > 01_Digoxin,_milrinone,_nesiritide'}, {'resource': 'Pathoma', 'chapter': '08_Cardiac > 02_Congestive_Heart_Failure'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 02_Carcinogenesis > 2_Oncogenes > Table_3.3_Important_Oncogenes > Nuclear_Regulators'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > Lolnotacop > 02_Carcinogenesis > 2_Oncogenes > Nuclear_Regulators'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 09_Tension_Headache'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > BlueGalaxies > 02_Carcinogenesis > 2_Oncogenes > Nuclear_Regulators'}]},
    summary: `
...
:::`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 05_Cranial_Nerves', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 04_Cranial_Nerves_-_Part_1'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 05_Cranial_Nerves_-_Part_2'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 01_Parasympathetic > 02_Acetylcholinesterase_Inhibitors'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 01_Parasympathetic > 03_Muscarinic_antagonists'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 03_Upper_Extremity_Nerves'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 01_Sympathomimetics'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 01_Parasympathetic > 01_Cholinomimetics'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 21_Basal_Ganglia'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves > CN_03_Oculomotor_Nerve'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 04_GI > 05_Layers_of_the_Intestinal_Wall'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 08_Basal_Ganglia_&_Dopaminergic_Pathways'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Axilla > Clinical_-_Lesion_of_Upper_Limb_Nerves'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 03_Alpha_drugs'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 01_Intracranial_Hypertension_(ICH)'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 04_Pediatric_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Headache > Idiopathic_Intracranial_Hypertension'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Aneurysms_and_Intracranial_Hemorrhage > Epidural_and_Subdural_Hematoma,_Subarachnoid_Hemorrhage'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 02_Hydrocephalus'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 09_Tension_Headache'}]},
    summary: `
...
`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '04_Pathology > 03_Neoplasia > 02_Tumor_Nomenclature > Examples', 'alternatives': [{'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Physiology > Vitamins'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > External_Examination_of_the_Brain_+_Skull > Veins,_Venous_Sinuses,_and_Dural_Folds'}, {'resource': 'B&B', 'chapter': '18_Pulm > 01_Intro > 09_Pulm_Physical_Exam'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}]},
    summary: `
...
`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 04_Protein_Synthesis_Inhibitors', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 07_Aminoglycosides'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 01_Tetracyclines'}, {'resource': 'SketchyPharm', 'chapter': 'Immunology-&-Biochemistry-Pharmacology > Immuno-suppressives > Transplant-Rejection-Prophylaxis'}, {'resource': 'SketchyPharm', 'chapter': '06_Neuro/Psych > 05_Antipsychotics_&_Parkinsons > 01_First_generation_antipsychotics'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names'}, {'resource': 'FirstAid', 'chapter': '03_Microbiology > 02_Clinical_Bacteriology > 39_Spirochetes'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 04_G-Protein-Linked_Second_Messengers'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 10_Drug_reactions_-_multiorgan'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 04_Acid/Base_Disorders'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 01_Osmolality_&_Sodium_Disorders'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 04_Clinical_Characteristics'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Fluid_&_Filtration_Physiology > Fluid_Physiology'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 03_Diabetes > 01_Diabetes_Mellitus:_Pathogenesis_&_Acute_Clinical_Manifestations'}, {'resource': 'Bootcamp', 'chapter': 'Genetics > DNA_Structure > Clinical_Applications_of_the_Pyrimidine_Pathway'}, {'resource': 'SketchyPath', 'chapter': '06_Hepatobiliary > 02_Liver_Disease > 01_Cirrhosis_-_Pathogenesis_&_Clinical_Manifestations'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 02_Cardio > 06_Pressure-Volume_Loops'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 14_Neuro > 21_Opioid_Clinical_Use,_Mechanism_and_Overdose'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 03_Calcium_Disorders'}, {'resource': 'Bootcamp', 'chapter': 'Genetics > DNA_Structure > Clinical_Applications_of_the_Purine_Pathway'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 24_Dyslipidemias_(deprecated) > 01_Apolipoproteins'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > BlueGalaxies > 04_Clinical_Characteristics > Basics'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 15_Pharm_Fundamentals > 02_Pharmacokinetics_and_Dosage_Calculations'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 04_Clinical_Characteristics > lol_extra'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 04_Clinical_Characteristics > bg_extra'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Fluid_&_Filtration_Physiology > Clearance_Renal_Plasma_and_Blood_Flow'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 15_Dermatomes,_Myotomes_&_Clinical_Reflexes'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > BlueGalaxies > 04_Clinical_Characteristics > Serum_Tumor_Markers'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 07_Endocrine > 01_Insulin_Preparations'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 19_Respiratory > 1st_Generation_Antihistamines'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 07_Diabetes > Insulin_Preparations'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 21_G-Protein-Coupled_Receptors > 05_Beta-2_Adrenergic_Receptors'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 21_G-Protein-Coupled_Receptors > 01_Alpha-1_Adrenergic_Receptors'}]},
    summary: `
...
-----\n\n## Core Concepts\n\n### Rational Dosing\n*   **Goal:** Achieve a beneficial effect with minimal adverse effects (maximize Benefit/Risk ratio).\n*   **Target Concentration Strategy:** Use population PK data to predict a dose that achieves a target plasma concentration known to be effective and safe.\n\n### Pharmacokinetic Parameters\n\n#### 1. Clearance (CL)\n*   **Definition:** The volume of blood (or plasma) from which drug is completely removed per unit time (e.g., L/hr or mL/min).\n*   **Significance:** The **most important** parameter for determining the **maintenance dose**.\n*   **Determinants:**\n    *   Blood flow to the organ of elimination (Q).\n    *   Extraction Ratio (ER) of the organ.\n*   **Equation:** $CL = Q \\times ER$\n*   **Total Clearance:** Sum of all clearance pathways (Renal + Hepatic + Others).\n\n#### 2. Volume of Distribution (Vd)\n*   **Definition:** The apparent volume into which a drug distributes to produce the observed plasma concentration.\n*   **Significance:** Determines the **loading dose**.\n*   **Equation:** $V_d = \\frac{\\text{Amount of Drug in Body}}{\\text{Plasma Concentration}}$\n*   **Interpretation:**\n    *   **Low Vd (~3-5 L):** Drug confined to plasma (large molecules, high protein binding).\n    *   **High Vd (>42 L):** Drug distributes extensively into tissues (lipophilic drugs).\n\n#### 3. Bioavailability (F)\n*   **Definition:** The fraction of the administered dose that reaches the systemic circulation unchanged.\n*   **Absolute Bioavailability:** $F = \\frac{AUC_{oral}}{AUC_{IV}}$\n*   **Determinants:**\n    *   Absorption (f).\n    *   First-pass elimination (Extraction Ratio).\n*   **Equation:** $F = f \\times (1 - ER)$\n*   **Clinical Note:** High extraction ratio drugs (e.g., Verapamil, Morphine) have low oral bioavailability. Liver disease (shunting) can drastically increase bioavailability and toxicity of these drugs.\n\n#### 4. Extraction Ratio (ER)\n*   **Definition:** Fraction of drug removed by an organ during one pass.\n*   **Equation:** $ER = \\frac{C_{in} - C_{out}}{C_{in}}$\n*   **Hepatic Extraction:**\n    *   **High ER:** Clearance depends on **blood flow** (flow-limited).\n    *   **Low ER:** Clearance depends on **intrinsic enzyme activity** (capacity-limited) and protein binding.\n\n#### 5. Protein Binding\n*   **Principle:** Only **unbound (free)** drug is active, metabolized, and excreted.\n*   **Displacement:** Drug A can be displaced by Drug B, increasing free Drug A.\n*   **Clinical Relevance:** Only significant for drugs with:\n    1.  High protein binding (>90%).\n    2.  **Narrow therapeutic window**.\n    3.  Small Volume of Distribution.\n\n## Definitions\n*   **Pharmaceutical Equivalents:** Same active ingredient, strength, dosage form, and route.\n*   **Bioequivalence:** Pharmaceutical equivalents with no significant difference in rate and extent of absorption (AUC, Cmax, Tmax).\n*   **Therapeutic Equivalents:** Bioequivalent products with same clinical safety and efficacy profile.\n`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '09_GI > 03_Clinical > 08_Gastric_Disorders', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology'}, {'resource': 'SketchyPharm', 'chapter': 'Immunology-&-Biochemistry-Pharmacology > Immuno-suppressives > Transplant-Rejection-Prophylaxis'}, {'resource': 'SketchyPharm', 'chapter': 'Immunology-&-Biochemistry-Pharmacology > Immuno-suppressives > General-Immunotherapy'}, {'resource': 'SketchyPharm', 'chapter': 'Immunology-&-Biochemistry-Pharmacology > Immuno-stimulants-&-Biochemistry-Pharmacology > Immunostimulants-(Interferons,Cytokine-Therapy)'}, {'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology > toxins'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 10_HemeOnc_Pathology > 14_Myeloproliferative_Disorders'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 14_Neuro > 21_Opioid_Clinical_Use,_Mechanism_and_Overdose'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 05_Neuropathology_Pathology > 05_Dementia_Degenerative_Disorders'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 07_Dementia_&_Degenerative_Disorders'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 03_Pathology > 14_Neurodegenerative_Disorders'}, {'resource': 'SketchyPath', 'chapter': '10_Myeloid_&_Lymphoid > 01_Myeloid_Disorders > 01_Myeloproliferative_Neoplasms_&_Myelodysplastic_Syndromes'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 04_Musculoskeletal_Pathology > 01_Bone_Disorders'}, {'resource': 'FirstAid', 'chapter': '03_Microbiology > 02_Clinical_Bacteriology > 39_Spirochetes'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue'}, {'resource': 'SketchyPath', 'chapter': '05_GI > 03_Colorectal_&_Anal_Disorders > 03_Colorectal_Polyps_&_Cancer'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 10_Drug_reactions_-_multiorgan'}, {'resource': 'Pathoma', 'chapter': '04_Hemostasis > 01_Primary_Hemostasis_&_Related_Bleeding_Disorders'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 01_Hypothalamic_&_Pituitary_Disorders > 02_Hypothalamic_&_Pituitary_Dysfunction_-_Clinical_Manifestations'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 06_Volume,_Electrolyte_&_Acid/base_Disorders > 04_Acid/Base_Disorders'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 05_Male_GU > 01_Testicular_Disorders_&_Cancer'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 04_Clinical_Characteristics'}, {'resource': 'Pathoma', 'chapter': '04_Hemostasis > 02_Secondary_Hemostasis_&_Related_Disorders'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 05_Neuropathology_Pathology > 09_Neurocutaneous_Disorders'}, {'resource': 'Pathoma', 'chapter': '08_Cardiac > 04_Valvular_Disorders'}, {'resource': 'Bootcamp', 'chapter': 'Genetics > DNA_Structure > Clinical_Applications_of_the_Pyrimidine_Pathway'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'Bootcamp', 'chapter': 'Genetics > DNA_Structure > Clinical_Applications_of_the_Purine_Pathway'}, {'resource': 'Bootcamp', 'chapter': 'Dermatology > Additional_Dermatologic_Disorders > Vascular_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Platelets > Platelet_Disorders'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 07_Tuberous_Sclerosis'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 10_Collagen_Related_Disorders > 05_Ehlers-Danlos_Syndrome'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 13_Neurological_Disorders > 01_Craniopharyngioma'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 10_Collagen_Related_Disorders > 06_Goodpasture_Syndrome'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 10_Collagen_Related_Disorders > 04_Collagen_Synthesis'}]},
    summary: `
...
-----\n\n## Core Concepts\n\n### Elimination Kinetics\n\n#### 1. Half-Life ($t_{1/2}$)\n*   **Definition:** Time required to reduce the amount of drug in the body by 50%.\n*   **Equation:** $t_{1/2} = \\frac{0.693 \\times V_d}{CL}$\n*   **Key Relationship:** $t_{1/2}$ is **inversely proportional** to Clearance (CL) and **directly proportional** to Volume of Distribution ($V_d$).\n*   **Clinical Utility:** Determines the time to reach steady state and the dosing interval.\n\n#### 2. First-Order Kinetics (Linear)\n*   **Mechanism:** A constant **fraction** (percentage) of drug is eliminated per unit time.\n*   **Characteristics:**\n    *   Rate of elimination is proportional to plasma concentration.\n    *   Most drugs follow this pattern at therapeutic doses.\n    *   $t_{1/2}$ is constant regardless of dose.\n\n#### 3. Zero-Order Kinetics (Non-Linear / Capacity-Limited)\n*   **Mechanism:** A constant **amount** (e.g., mg/hr) of drug is eliminated per unit time.\n*   **Cause:** Saturation of elimination mechanisms (enzymes/transporters).\n*   **Characteristics:**\n    *   Rate of elimination is independent of concentration.\n    *   No true constant $t_{1/2}$.\n    *   Small dose increases can lead to disproportionate increases in concentration (toxicity risk).\n*   **Examples:** Phenytoin, Ethanol, Aspirin (high doses).\n\n### Dosing Strategies\n\n#### 1. Steady State ($C_{ss}$)\n*   **Definition:** Rate of drug administration = Rate of drug elimination.\n*   **Time to Reach:** Takes **4-5 half-lives** to reach ~94-97% of steady state.\n*   **Note:** Time to steady state depends **only on half-life**, not on the dose size or frequency.\n\n#### 2. Loading Dose (LD)\n*   **Purpose:** To rapidly achieve therapeutic plasma concentrations (fill the $V_d$).\n*   **Equation:** $LD = \\frac{V_d \\times \\text{Target Concentration}}{F}$\n*   **Clinical Use:** Emergencies or drugs with very long half-lives (e.g., Amiodarone, Digoxin).\n\n#### 3. Maintenance Dose (MD)\n*   **Purpose:** To maintain steady state by replacing the amount of drug cleared.\n*   **Equation:** $MD = \\frac{CL \\times \\text{Target Concentration}}{F}$\n*   **Clinical Use:** Long-term therapy.\n\n### Therapeutic Drug Monitoring (TDM)\n*   **Indications:**\n    *   Narrow therapeutic window (e.g., Theophylline, Lithium, Digoxin).\n    *   High inter-patient variability.\n    *   Significant toxicity risk.\n    *   Relationship between concentration and effect is known.\n*   **Sampling:** Must be done at steady state (usually trough levels) to be meaningful.\n\n### Individualizing Therapy\n*   **Factors Affecting PK:**\n    *   **Age:** Reduced muscle mass, renal function.\n    *   **Obesity:** Increased $V_d$ for lipophilic drugs.\n    *   **Disease:** Liver failure (reduced CL), Renal failure (reduced CL), Heart failure (reduced perfusion).\n    *   **Fluid Status:** Edema/Ascites increases $V_d$ for hydrophilic drugs.\n`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 01_Sympathomimetics'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 01_Heart_Failure_Drugs > 02_ACE_inhibitors,_ARBs,_Aliskiren'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 03_Alpha_drugs'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 04_Beta_blockers'}, {'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology'}, {'resource': 'B&B', 'chapter': '11_Hematology > 04_Cancer_Drugs > 01_Antimetabolites'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 06_Viruses > 07_HIV_Drugs'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 04_Fungi > 04_Antifungal_Drugs'}, {'resource': 'B&B', 'chapter': '05_Cardio > 04_Arrhythmias > 06_Antiarrhythmic_Drugs'}, {'resource': 'B&B', 'chapter': '15_Neuro > 04_ANS > 03_ANS_Drugs-_Acetylcholine'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 22_Dapsone,_Rifamycins,_Clofazimine_(Leprosy_Drugs)'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 07_Endocrine > 13_ADH-Related_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 07_Cyclophosphamide,_Ifosfamide'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 11_Azathioprine,_6-MP'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 14_Neuro > 19_Neuromuscular_Blocking_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 08_Cisplatin,_Carboplatin,_Oxaliplatin'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 08_Respiratory > 05_Pulmonary_HTN_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 02_Rituximab'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 20_Bleomycin'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 15_Pharm_Fundamentals > 03_Drug_Metabolism,_Elimination,_and_Urine_pH'}, {'resource': 'SketchyPath', 'chapter': '09_Blood_&_Coagulation > 02_Normocytic_&_Macrocytic_Anemias > 03_G6PD_Deficiency_&_Autoimmune_Hemolytic_Anemia_(AIHA)'}, {'resource': 'SketchyMicro', 'chapter': '01_Bacteria > 10_Gram-indeterminate_Bacteria > 01_Chlamydia_trachomatis,_Chlamydophila_pneumoniae_&_Chlamydophila_psittaci'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Normocytic_Anemia > G6PD_Deficiency'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Immunology > Hypersensitivities > Type_I_Hypersensitivity_Reactions'}]},
    summary: `
...
-----\n\n## Adverse Drug Reactions (ADRs)\n\n### Classification\n*   **Type A (Predictable):** Dose-dependent, related to the drug's pharmacological action. Common (e.g., overdose, side effects, withdrawal, drug interactions).\n*   **Type B (Unpredictable):** Idiosyncratic, often immunologic (allergic). Rare and not dose-dependent (e.g., anaphylaxis, SJS).\n\n### Mechanisms of Toxicity\n*   **On-Target:** Exaggerated effect at the target receptor (e.g., hypoglycemia from insulin).\n*   **Off-Target:** Interaction with unintended receptors (e.g., antihistamines causing drowsiness via muscarinic receptors).\n*   **Cellular Toxicity:** Apoptosis (programmed cell death, less inflammation) vs. Necrosis (cell lysis, significant inflammation).\n*   **Organ Toxicity:** Hepatotoxicity, Nephrotoxicity, Neurotoxicity (peripheral neuropathy), Bone Marrow Suppression.\n\n## Special Populations\n\n### Pregnancy & Lactation\n*   **Pregnancy and Lactation Labeling Rule (PLLR):** Replaced the old A, B, C, D, X categories. Now provides:\n    1.  **Pregnancy:** Risk summary, clinical considerations, data.\n    2.  **Lactation:** Risk to infant, drug presence in milk.\n    3.  **Females/Males of Reproductive Potential:** Testing, contraception, infertility.\n*   **Teratogenesis:** Drug-induced defects during organogenesis (embryonic period).\n*   **Fetotoxicity:** Injury to fetus at any stage (e.g., growth restriction, death).\n*   **Neonatal Abstinence Syndrome (NAS):** Withdrawal syndrome in neonates exposed to opioids, alcohol, or sedatives in utero.\n\n## Pharmacogenomics\n\n### Key Gene-Drug Interactions\n\n#### 1. N-acetyltransferase 2 (NAT2)\n*   **Phenotype:** Slow Acetylators.\n*   **Risk:** Increased risk of **Drug-Induced Lupus** (Hydralazine, Procainamide, Isoniazid) and peripheral neuropathy (Isoniazid).\n\n#### 2. CYP2D6\n*   **Substrate:** Codeine (prodrug converted to Morphine).\n*   **Ultra-Rapid Metabolizers (UM):** Rapid conversion to Morphine $\\rightarrow$ **Respiratory Depression/Death** (especially in children/breastfed infants).\n*   **Poor Metabolizers (PM):** Little conversion $\\rightarrow$ Lack of analgesic efficacy.\n\n#### 3. UGT1A1\n*   **Function:** Conjugates bilirubin.\n*   **Variant:** Reduced activity (Gilbert Syndrome).\n*   **Drug:** **Irinotecan** (chemotherapy). Reduced clearance leads to severe neutropenia and diarrhea.\n\n#### 4. G6PD Deficiency\n*   **Mechanism:** Reduced NADPH production $\\rightarrow$ inability to neutralize oxidative stress (glutathione).\n*   **Risk:** **Hemolytic Anemia** upon exposure to oxidizing drugs (Sulfonamides, Nitrofurantoin, Primaquine, Fava beans).\n\n#### 5. HLA-B*5701\n*   **Drug:** **Abacavir** (HIV antiviral).\n*   **Risk:** Severe, life-threatening hypersensitivity reaction (SJS/TEN).\n*   **Action:** **Screening is mandatory** before starting Abacavir.\n\n#### 6. VKORC1\n*   **Drug:** Warfarin.\n*   **Variant:** Polymorphisms affect sensitivity to Warfarin, requiring dose adjustments.\n`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 01_Sympathomimetics'}, {'resource': 'SketchyPharm', 'chapter': '!General_Pharmacology'}, {'resource': 'SketchyPharm', 'chapter': '02_Cardio_&_Renal > 01_Heart_Failure_Drugs > 02_ACE_inhibitors,_ARBs,_Aliskiren'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 03_Alpha_drugs'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 02_Sympathetic > 04_Beta_blockers'}, {'resource': 'B&B', 'chapter': '11_Hematology > 04_Cancer_Drugs > 01_Antimetabolites'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 06_Viruses > 07_HIV_Drugs'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 04_Fungi > 04_Antifungal_Drugs'}, {'resource': 'B&B', 'chapter': '05_Cardio > 04_Arrhythmias > 06_Antiarrhythmic_Drugs'}, {'resource': 'B&B', 'chapter': '15_Neuro > 04_ANS > 03_ANS_Drugs-_Acetylcholine'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 22_Dapsone,_Rifamycins,_Clofazimine_(Leprosy_Drugs)'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 07_Endocrine > 13_ADH-Related_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 07_Cyclophosphamide,_Ifosfamide'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 11_Azathioprine,_6-MP'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 14_Neuro > 19_Neuromuscular_Blocking_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 08_Cisplatin,_Carboplatin,_Oxaliplatin'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 08_Respiratory > 05_Pulmonary_HTN_Drugs'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 02_Rituximab'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 22_Onc_Drugs > 20_Bleomycin'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 15_Pharm_Fundamentals > 03_Drug_Metabolism,_Elimination,_and_Urine_pH'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Atypical_Antipsychotics'}]},
    summary: `
...
`,
  ...
  },
  {
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '03_Microbiology > 05_Virology > 12_RNA_Viruses', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 01_Penicillin'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 04_Other_Antibiotics > 01_Trimethoprim/Sulfamethoxazole'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 04_Cephalosporins'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 03_Ampicillin,_Amoxicillin,_Piperacillin,_Ticarcillin'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 06_Vancomycin'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 04_Protein_Synthesis_Inhibitors'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 01_Penicillins'}, {'resource': 'B&B', 'chapter': '15_Neuro > 04_ANS > 04_Autonomic_Receptors'}, {'resource': 'B&B', 'chapter': '05_Cardio > 04_Arrhythmias > 06_Antiarrhythmic_Drugs'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'SketchyMicro', 'chapter': 'uw_micro_(do_this_one_last)'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 01_Basics_of_Microbiology > 01_Bacteria'}, {'resource': 'Pathoma', 'chapter': '08_Cardiac > 01_Ischemic_Heart_Disease'}, {'resource': 'Physeo', 'chapter': '06_Micro > 05_Viruses > 09_Human_Papillomavirus'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 03_Antivirals > NRTIs'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 01_Hypothalamic_&_Pituitary_Disorders > 04_Diabetes_Insipidus_&_SIADH'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Carbapenems'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 16_Macrolides'}, {'resource': 'SketchyMicro', 'chapter': 'uw_micro_(do_this_one_last)"'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Linezolid'}, {'resource': 'Physeo', 'chapter': '06_Micro > 02_Bacteria > 11_Strep_Pyogenes'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 01_Hypothalamic_&_Pituitary_Disorders > 03_Hyperpituitarism'}, {'resource': 'SketchyPath', 'chapter': '09_Blood_&_Coagulation > 01_Microcytic_Anemias > 02_Iron_Deficiency_Anemia_&_Anemia_of_Chronic_Disease'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 01_Hypothalamic_&_Pituitary_Disorders > 01_Hypothalamic_&_Pituitary_Dysfunction_-_Etiologies'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 01_Cerebrovascular > 02_Ischemic_&_Hemorrhagic_Stroke'}, {'resource': 'Pathoma', 'chapter': '05_RBC > 02_Microcytic_Anemias > part_3'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 02_Carcinogenesis > 1_Important_Carcinogens > Table_3.2_Important_Carcinogens > Chemicals'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Ischemic_Cerebrovascular_Accidents > Stroke_Presentation_by_Territory'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Antiarrhythmics > Class_I_Antiarrhythmics'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Microcytic_Anemia > Iron_Deficiency_Anemia'}, {'resource': 'Pathoma', 'chapter': '05_RBC > 02_Microcytic_Anemias > part_1'}, {'resource': 'Bootcamp', 'chapter': 'Microbiology > Fundamentals_of_Bacteriology > Bacterial_Morphology'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 05_Helminths_-_Nematodes > 01_Enterobius_vermicularis,_Ancylostoma_duodenale,_Necator_americanus,_Ascaris_lumbricoides,_Strongyloides_stercoralis,_Trichinella_spiralis_(intestinal_nematodes)'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > BlueGalaxies > 02_Carcinogenesis > 1_Important_Carcinogens > Chemicals'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Platelets > Thrombotic_Microangiopathies'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 02_Cutaneous_Mycoses > 02_Epidermophyton_spp.,_Trichophyton_spp.,_Microsporum_spp._(dermatophytes)'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 01_Systemic_Mycoses > 01_Histoplasma_capsulatum'}]},
    summary: `
...
-----\n\n## Principles of Antimicrobial Therapy\n\n### Key Concepts\n*   **Selective Toxicity:** The ability of a drug to kill or inhibit the microbe without harming the host cells at therapeutic concentrations.\n*   **Microbicidal (Bactericidal/Fungicidal):** Kills the organism. Preferred in immunocompromised patients or serious infections (e.g., endocarditis, meningitis).\n*   **Microbistatic (Bacteriostatic/Fungistatic):** Inhibits growth/replication. Relies on the host's immune system to clear the infection.\n*   **Susceptibility:** Actively growing organisms are generally more susceptible to drugs targeting synthesis (cell wall, protein, etc.) than resting organisms.\n\n### Mechanisms of Resistance\nResistance can be **Intrinsic** (natural) or **Acquired** (mutation/gene transfer under selection pressure).\n\n1.  **Decreased Entry:** Alteration of porins (Gram-negative bacteria) prevents drug access.\n2.  **Efflux Pumps:** Active transport of drug OUT of the cell.\n3.  **Enzymatic Inactivation:** Production of enzymes that destroy the drug (e.g., Beta-lactamases).\n4.  **Target Alteration:** Mutation of the binding site so the drug can no longer bind (e.g., altered Penicillin-Binding Proteins).\n5.  **Alternative Metabolic Pathways:** Bypassing the inhibited pathway (e.g., synthesizing folate via a different route).\n\n## Pharmacodynamics (PK/PD)\n\n### Measures of Potency\n*   **Minimum Inhibitory Concentration (MIC):** The lowest concentration of drug that inhibits visible growth of the organism. Key predictor of efficacy.\n*   **Minimum Bactericidal Concentration (MBC):** The lowest concentration that kills 99.9% of the inoculum.\n\n### Killing Profiles\n1.  **Concentration-Dependent Killing:** Rate and extent of killing increase with higher peak concentrations.\n    *   *Goal:* Maximize **Peak/MIC** or **AUC/MIC**.\n    *   *Dosing:* Large, less frequent doses (e.g., Aminoglycosides).\n    *   *Post-Antibiotic Effect (PAE):* Long suppression of growth after drug levels fall below MIC.\n2.  **Time-Dependent Killing:** Efficacy depends on the duration the drug concentration remains above the MIC (**T > MIC**).\n    *   *Goal:* Keep levels > MIC for >50% of dosing interval.\n    *   *Dosing:* Frequent doses or continuous infusion (e.g., Beta-lactams).\n    *   *PAE:* Minimal/Short.\n\n## Therapeutic Goals\n1.  **Prophylactic:** Prevent infection in high-risk scenarios (e.g., surgery, dental procedures in at-risk cardiac patients).\n2.  **Preemptive:** Treat high-risk asymptomatic patients (e.g., CMV in transplant recipients).\n3.  **Empiric:** Immediate treatment of symptomatic infection based on likely pathogens *before* culture results. Uses **Broad-Spectrum** agents.\n4.  **Definitive:** Targeted treatment based on culture and sensitivity results. Uses **Narrow-Spectrum** agents to reduce toxicity and resistance.\n5.  **Suppressive:** Long-term low-dose therapy to prevent recurrence (e.g., in HIV or transplant patients).\n\n## Antibiotic Stewardship\n*   **Goals:** Improve patient outcomes, reduce resistance, decrease spread of multidrug-resistant organisms (MDROs), reduce *C. difficile* infections.\n*   **The 5 D's:**\n    1.  Right **Drug**\n    2.  Right **Dose**\n    3.  Right **Duration**\n    4.  Right **Diagnosis**\n    5.  Right **De-escalation** (or Right Patient/Time)\n*   **General Rule:** Use a single agent (monotherapy) whenever possible to reduce cost, toxicity, and resistance. Use combination therapy only for specific indications (synergy, broadening spectrum for empiric therapy, preventing resistance in TB/HIV).\n`,
  ...
  },
  {
    ...
    ankingResource: {'primarySource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 01_Penicillin', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 02_Nafcillin,_Oxacillin,_Methicillin_&_Dicloxacillin'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 03_Ampicillin,_Amoxicillin,_Piperacillin,_Ticarcillin'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 10_Drug_reactions_-_multiorgan'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 04_Drug_reactions_-_gastrointestinal'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 01_Autonomic_Receptors'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 03_Antistaphylococcal_Penicillins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 16_Macrolides'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 10_Aminoglycosides'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Carbapenems'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Linezolid'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Atypical_Antipsychotics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Daptomycin'}]},
    summary: `
...
`,
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Anti-Staphylococcal penicillins (Nafcillin, Oxacillin, Dicloxacillin) are primarily eliminated by the liver (biliary excretion) and do not require renal dosage adjustment. Most other beta-lactams are renally eliminated."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Aminopenicillins (Amoxicillin, Ampicillin) are associated with a high incidence of a non-allergic maculopapular rash when administered to patients with viral infections like Mononucleosis (EBV) or those taking Allopurinol."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Piperacillin is an antipseudomonal penicillin. When combined with Tazobactam (Zosyn), it retains activity against *Pseudomonas* and covers beta-lactamase-producing strains. The other options do not cover *Pseudomonas*."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Probenicid inhibits the organic anion transporter in the renal proximal tubule, blocking the secretion of penicillins. This increases their plasma concentration and prolongs their half-life."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Acute Interstitial Nephritis (AIN) is a classic adverse effect of Methicillin (which led to its withdrawal). It can also occur with other penicillins, particularly Nafcillin and Oxacillin, but is less common."
      }
    ],
    glossary: [
  ...
  {
    id: "L121",
    title: "L121 - OMM: Lab 13 Prep - Lumbar HVLA and Posterior Counterstrain",
    module: "OMM",
    tags: ["OMM", "Lumbar", "HVLA", "Counterstrain", "Somatic Dysfunction"],
    createdAt: "2024-11-26",
    ankingResource: null,
    summary: `
**Lecturer:** Unknown Lecturer
...
## Lumbar Diagnosis Review
*   **Screening:** Identify posterior transverse processes to determine rotational freedom.
*   **Landmarks:**
    *   **12th Rib:** T12.
...
*   **Type 1 (Neutral):**
    ...
    *   Asymmetry does **NOT** improve significantly with flexion or extension.
*   **Type 2 (Non-Neutral):**
    *   Single segment.
    *   **Sidebending and Rotation in the SAME direction.**
    *   Asymmetry **IMPROVES** in either flexion or extension.
*   **Confirmation:** Induce lateral translation to determine sidebending freedom.

## Lumbar HVLA (High Velocity, Low Amplitude)
*   **Type:** Passive, Direct technique.
*   **Principles:**
    1.  Identify restricted segment.
    2.  **Always perform Soft Tissue first.**
    3.  Localize precisely to the restrictive barrier.
    4.  Apply HVLA thrust (quick, short distance) through the barrier.
    5.  Reassess.
*   **Contraindications:**
    *   **Absolute:** No somatic dysfunction, no consent, patient intolerance, **osteoporosis**, **osteomyelitis**, **fractures**, bone cancer, hardware in joint, severe **Rheumatoid Arthritis**.
    *   **Relative:** Acute whiplash/pain, pregnancy, post-surgical complications, **herniated discs**, anticoagulant use.
*   **Technique Setup (Lateral Recumbent):**
    *   **Type 1 (Neutral):** Long lever with rotational and sidebending emphasis.
    *   **Type 2 (Non-Neutral):** Long lever. Flex or extend hips/knees to localize to the specific segment.

## Posterior Lumbar Counterstrain
*   **Type:** Passive, Indirect technique.
*   **Tender Points:** Discrete areas of tissue texture abnormality and tenderness.
*   **Contraindications:**
    *   **Absolute:** Neuro/vascular symptoms induced by position, exacerbation of life-threatening symptoms.
    *   **Relative:** Inability to relax, severe illness, cervical instability (for cervical CS), apprehension.
*   **Tender Point Locations:**
    *   **Spinous Process (PL1-PL5):** On the **inferolateral** aspect of the spinous process of the dysfunctional segment.
    *   **Transverse Process (PL1-PL5):** On the **posterolateral** aspect of the transverse process of the dysfunctional segment.
*   **Treatment Position (Prone):**
    *   **Extension:** Lift the ASIS on the side of the tender point (extends the spinal level).
    *   **Rotation:** Rotate pelvis/lower segment **TOWARD** the tender point (lift ASIS).
    *   **Sidebending:** Sidebend **AWAY** from the tender point (adduct the lower extremity).
    *   **Mnemonic:** **E-SARA** (Extend, Sidebend Away, Rotate Toward - *Note: Rotation is of the segment, often achieved by rotating pelvis toward*). **Lift ASIS (Extend + Rotate Toward), Adduct Leg (Sidebend Away).**

`,
    questions: [
      {
        question: "A patient presents with lower back pain. Diagnosis reveals L4 is rotated right and sidebent left. The asymmetry does not change with flexion or extension. What is the diagnosis?",
        options: [
          "L4 Flexed Rotated Right Sidebent Right",
          "L4 Extended Rotated Right Sidebent Right",
          "L4 Neutral Rotated Right Sidebent Left",
          "L4 Neutral Rotated Left Sidebent Right"
        ],
        correctAnswer: 2,
        rationale: "The rotation and sidebending are in opposite directions (Rotated Right, Sidebent Left), and the dysfunction does not improve with flexion or extension. This indicates a Type 1 (Neutral) somatic dysfunction: L4 N S(L) R(R)."
      },
      {
        question: "Which of the following is an ABSOLUTE contraindication to performing HVLA on the lumbar spine?",
        options: [
          "Acute lumbar strain",
        ...
        correctAnswer: 2,
        rationale: "Osteoporosis is an absolute contraindication due to the risk of fracture. Acute strain, herniated disc, and pregnancy are relative contraindications."
      },
      {
        question: "For a Posterior Lumbar Counterstrain point located on the transverse process of L3 on the right, what is the correct treatment position?",
        options: [
          "Prone, Extend, Sidebend Toward, Rotate Away",
          "Prone, Extend, Sidebend Away, Rotate Toward",
          "Supine, Flex, Sidebend Toward, Rotate Toward",
          "Supine, Flex, Sidebend Away, Rotate Away"
        ],
        correctAnswer: 1,
        rationale: "Posterior lumbar tender points are treated in prone extension. The specific setup involves lifting the ASIS on the affected side (which extends and rotates the pelvis/segment toward the tender point) and adducting the leg (which sidebends the torso away from the tender point). So: Extend, Sidebend Away, Rotate Toward."
      },
      {
        question: "What landmark corresponds to the level of the iliac crests?",
        options: [
          "L2-L3 interspace",
          "L3-L4 interspace",
          "L4-L5 interspace",
        ...
        correctAnswer: 2,
        rationale: "The iliac crests are generally at the level of the L4-L5 interspace."
      }
    ],
    glossary: [
      { term: "HVLA", definition: "High Velocity, Low Amplitude; a direct, passive osteopathic technique involving a quick thrust through a restrictive barrier." },
      { term: "Counterstrain", definition: "An indirect, passive osteopathic technique that places the patient in a position of ease to relieve tender points." },
      { term: "Type 1 Dysfunction", definition: "Somatic dysfunction occurring in neutral, involving a group of vertebrae, with sidebending and rotation in opposite directions." },
      { term: "Type 2 Dysfunction", definition: "Somatic dysfunction occurring in flexion or extension, involving a single segment, with sidebending and rotation in the same direction." },
      { term: "Tender Point", definition: "A discrete area of tissue texture abnormality that is tender to palpation and responds to positional release." }
    ]
  },
  {
    id: "L122",
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'Bootcamp', 'chapter': 'Gastroenterology > Physiology > Vitamins', 'alternatives': [{'resource': 'FirstAid', 'chapter': '04_Pathology > 03_Neoplasia > 02_Tumor_Nomenclature > Examples'}, {'resource': 'B&B', 'chapter': '18_Pulm > 01_Intro > 09_Pulm_Physical_Exam'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 10_Knee_Exam'}, {'resource': 'FirstAid', 'chapter': '13_Psychiatry > 02_Pathology > 02_Child_Abuse > Physical_Abuse'}, {'resource': 'FirstAid', 'chapter': '09_Gastrointestinal > 02_Anatomy > 05_Abdominal_Aorta_&_Branches'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 10_Knee_Exam > ACL'}]},
    summary: `
...
`,
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "The presentation of RUQ pain radiating to the right scapula (Boas' sign) combined with a positive Murphy's sign (inspiratory arrest on RUQ palpation) is classic for Acute Cholecystitis."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Rovsing's sign is referred rebound tenderness where palpation of the LLQ causes pain in the RLQ, suggestive of appendicitis."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "A positive Psoas sign indicates irritation of the psoas muscle, which typically occurs when the appendix is in a retrocecal position."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Unintentional weight loss is a red flag that may suggest malignancy (colon cancer) or other serious organic pathology. The other options are typical symptoms of functional constipation."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Lloyd's sign or Costovertebral Angle (CVA) tenderness is elicited by percussion over the kidney area and suggests renal pathology such as pyelonephritis, stones, or abscess."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 04_Cephalosporins', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 05_Monobactams_&_Carbapenems'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 01_Cell_Wall_&_Membrane_Active_Antibiotics > 06_Vancomycin'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 15_Phosphodiesterase_Inhibitors'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 10_Drug_reactions_-_multiorgan'}, {'resource': 'Physeo', 'chapter': '08_Immunology > 01_Immunology > 18_B_Cells'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 04_Drug_reactions_-_gastrointestinal'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 08_Vancomycin'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 06_Gastrointestinal_Pathology > 14_Other_Liver_Conditions'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Carbapenems'}, {'resource': 'SketchyPath', 'chapter': '10_Myeloid_&_Lymphoid > 02_Lymphoid_&_Plasma_Cell_Disorders > 01_Acute_Lymphoblastic_Leukemia_(ALL),_Chronic_Lymphocytic_Leukemia_(CLL),_Hairy_Cell_Leukemia_&_Adult_T-cell_Leukemia'}, {'resource': 'Pathoma', 'chapter': '01_Growth_Adaptations > 03_Cell_Death'}, {'resource': 'SketchyPath', 'chapter': '10_Myeloid_&_Lymphoid > 02_Lymphoid_&_Plasma_Cell_Disorders > 03_Non-Hodgkin_Lymphoma'}, {'resource': 'SketchyPath', 'chapter': '06_Hepatobiliary > 03_Pancreatic_Disease > 02_Pancreatic_Cancer_&_Islet_Cell_Tumors'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Normocytic_Anemia > Sickle_Cell_Anemia'}, {'resource': 'SketchyPath', 'chapter': '09_Blood_&_Coagulation > 02_Normocytic_&_Macrocytic_Anemias > 04_Sickle_Cell_Disease'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Daptomycin'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 05_Renal_Cancer > 01_Renal_Cell_Carcinoma_&_Nephroblastoma'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 17_Renal > ACE_Inhibitors'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 15_Other_Neuro > Full_Opioid_Agonists'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Pathoma', 'chapter': '04_Hemostasis > 03_Other_Disorders_of_Hemostasis'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'SketchyMicro', 'chapter': '03_Viruses > 03_DNA > 04_Varicella-zoster_virus_(Herpesviridae)'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Pathoma', 'chapter': '06_WBC > 08_Plasma_Cell_(Dyscrasias)'}, {'resource': 'Pathoma', 'chapter': '01_Growth_Adaptations > 02_Cellular_Injury'}, {'resource': 'Pathoma', 'chapter': '06_WBC > 09_Langerhans_Cell_Histiocytosis'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 04_Protozoa_-_Other_Tissue > 01_Trichomonas_vaginalis'}, {'resource': 'SketchyMicro', 'chapter': '01_Bacteria > 07_Gram_(-)_Bacilli_-_Zoonotics > 02_Brucella_spp.'}]},
    summary: `
...
`,
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Ceftriaxone is highly protein-bound and can displace bilirubin, leading to kernicterus in neonates. It can also precipitate with calcium. Cefotaxime is preferred."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Daptomycin can cause myopathy and rhabdomyolysis. CPK levels must be monitored weekly during therapy."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Imipenem is rapidly inactivated by renal dehydropeptidase I. Cilastatin inhibits this enzyme, increasing the half-life and urinary concentration of Imipenem."
      },
      {
        ...
        correctAnswer: 3,
        rationale: "VRE resistance is mediated by the modification of the D-Ala-D-Ala binding site to D-Ala-D-Lactate, which prevents Vancomycin from binding."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Ceftaroline (5th generation) is the only beta-lactam with activity against MRSA due to its ability to bind PBP2a."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 07_Aminoglycosides', 'alternatives': [{'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 04_Protein_Synthesis_Inhibitors'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 10_Aminoglycosides'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 01_Penicillins'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 02_Beta_Lactams'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 16_Macrolides'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 05_Other_Antibiotics'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 01_Penicillin_G,_V'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 03_Sulfonamides'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Carbapenems'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Linezolid'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Atypical_Antipsychotics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Daptomycin'}]},
    summary: `
...
`,
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Amikacin is resistant to many of the bacterial transferase enzymes that inactivate Gentamicin and Tobramycin, making it effective against resistant strains."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Aminoglycosides inhibit pre-synaptic voltage-gated calcium channels, preventing the influx of calcium required for the release of acetylcholine vesicles."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "The transport of aminoglycosides across the bacterial cell membrane is an energy-dependent process that requires oxygen. Therefore, strict anaerobes are intrinsically resistant."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Aminoglycoside ototoxicity is caused by the destruction of hair cells in the Organ of Corti (cochlear toxicity) and hair cells in the ampullae (vestibular toxicity). This damage is often irreversible."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 01_Tetracyclines', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 03_Macrolides'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 04_Clindamycin'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 05_Chloramphenicol'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 02_Inhibitors_of_Bacterial_Protein_Synthesis > 06_Linezolid'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 04_Misc > 01_Drug_names'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 15_Phosphodiesterase_Inhibitors'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 06_Drug_reactions_-_MSK/skin/connect_tissue'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 10_Drug_reactions_-_multiorgan'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 03_Toxicities_&_Side_Effects > 04_Drug_reactions_-_gastrointestinal'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 16_Macrolides'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 11_Tetracyclines'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 14_Clindamycin'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Linezolid'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 02_Pathways > 12_De_Novo_Pyrimidine_Synthesis'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 17_Renal > ACE_Inhibitors'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 09_GI > Proton_Pump_Inhibitors_(PPIs)'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Atypical_Antipsychotics'}, {'resource': 'Pathoma', 'chapter': '05_RBC > heme_synthesis'}]},
    summary: `
...
`,
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Doxycycline is the drug of choice for Lyme disease. Although tetracyclines are generally contraindicated in children < 8 years due to teeth staining, the AAP allows Doxycycline for short courses (< 21 days) as it binds calcium less avidly than other tetracyclines."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Clarithromycin (and Erythromycin) is a potent inhibitor of CYP3A4. Simvastatin is metabolized by CYP3A4. Inhibition leads to increased statin levels and toxicity (rhabdomyolysis). Azithromycin does not inhibit CYP3A4."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Linezolid is a weak inhibitor of Monoamine Oxidase (MAO). Co-administration with serotonergic drugs (like SSRIs) can lead to Serotonin Syndrome."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "A positive D-test indicates inducible Clindamycin resistance (erm gene). Erythromycin induces the methylase enzyme, which then confers resistance to Clindamycin. Clindamycin should NOT be used."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 04_Other_Antibiotics > 01_Trimethoprim/Sulfamethoxazole', 'alternatives': [{'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 04_Other_Antibiotics > 02_Fluoroquinolones'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 04_Protein_Synthesis_Inhibitors'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 19_Fluoroquinolones'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 18_Trimethoprim_&_Sulfonamides'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 01_Penicillins'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 03_Sulfonamides'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 02_Beta_Lactams'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 05_Cephalosporins'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 16_Macrolides'}, {'resource': 'B&B', 'chapter': '13_Infectious_Disease > 03_Antibiotics > 05_Other_Antibiotics'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 05_Antibiotics > 10_Aminoglycosides'}, {'resource': 'SketchyPath', 'chapter': '09_Blood_&_Coagulation > 02_Normocytic_&_Macrocytic_Anemias > 05_Megaloblastic_Anemia:_Folate_Deficiency_&_Vitamin_B12_Deficiency'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Metronidazole'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Tricyclic_Antidepressants'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > Typical_Antipsychotics'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > MAOIs'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Macrocytic_Anemia > Folate_(Vitamin_B9)_Deficiency'}, {'resource': 'Bootcamp', 'chapter': 'Psychiatry > Pharmacology > SSRIs'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Carbapenems'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Linezolid'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 01_Antibiotics_Antiparasitics > Daptomycin'}]},
    summary: `
...
`,
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "TMP-SMX is the drug of choice for both treatment and prophylaxis of Pneumocystis jirovecii pneumonia (PCP) in immunocompromised patients."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Fluoroquinolones like Ciprofloxacin have a Black Box Warning for tendonitis and tendon rupture, most commonly affecting the Achilles tendon."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Moxifloxacin is primarily metabolized by the liver and excreted in the feces. It does not achieve adequate concentrations in the urine to treat UTIs."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Sulfonamides (like Sulfamethoxazole) can displace bilirubin from albumin, leading to kernicterus (brain damage) in neonates. They are contraindicated in the third trimester and in newborns."
      }
    ],
    glossary: [
  ...
  {
    id: 'l127',
    title: 'L127 - Anatomy: The Orbit and Extraocular Muscles',
    module: 'Anatomy',
    tags: 'Orbit, Extraocular Muscles, Eye, Cranial Nerves, Blowout Fracture',
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 05_Cranial_Nerves', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 04_Cranial_Nerves_-_Part_1'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 05_Cranial_Nerves_-_Part_2'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 09_Lower_Extremity_Nerves'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'FirstAid', 'chapter': '11_Musculoskeletal_Skin_Connective_Tissue > 01_Anatomy_&_Physiology > 03_Upper_Extremity_Nerves'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 05_Ophthalmology > 01_Normal_Eye_Anatomy'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Visceral_Anatomy > Embryology'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 33_Cranial_Nerves > CN_03_Oculomotor_Nerve'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 04_GI > 05_Layers_of_the_Intestinal_Wall'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Axilla > Clinical_-_Lesion_of_Upper_Limb_Nerves'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 08_MSK > 02_Lower_Trunk_&_the_Median_&_Ulnar_Nerves'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 01_Intracranial_Hypertension_(ICH)'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 04_Pediatric_CNS_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Aneurysms_and_Intracranial_Hemorrhage > Epidural_and_Subdural_Hematoma,_Subarachnoid_Hemorrhage'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Cranial_Nerves_7-12 > Cranial_Nerve_VII'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 02_Hydrocephalus'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 02_Pathways > 04_Sorbitol_(Polyol)_Pathway'}]},
    summary: `

**Lecturer:** Dr. Jonathan Geisler
**Session:** Lecture #127

-----

## Part 1: Orbit Boundaries and Contents

### Orbit Structure
*   **Shape:** Pyramid with apex posteriorly and four sides (roof, medial, floor, lateral).
*   **Adipose Tissue:** The orbit contains significant adipose tissue (visible as bright on T2 MRI), which is **non-compressible** like a fluid.
*   **Clinical Significance:** Pressure in the orbit can cause trauma as the fat cannot be compressed and must go somewhere.

### Bones of the Orbit
*   **Roof:** Frontal bone (predominantly), Lesser wing of sphenoid (small contribution).
*   **Lateral Wall:** Greater wing of sphenoid, Zygomatic bone.
*   **Floor:** Maxilla (predominantly).
...
*   **Function:** Elevates the superior eyelid.
*   **Origin:** Lesser wing of sphenoid.
*   **Insertion:** Superior tarsus (upper eyelid).
*   **Innervation:** Oculomotor nerve (CN III). Contains smooth muscle fibers innervated by **sympathetics** (superior cervical ganglion).

### Rectus Muscles (4)
*   **Muscles:** Superior, Inferior, Medial, Lateral Rectus.
*   **Origin:** Common tendinous ring (attached to lesser wing of sphenoid).
*   **Insertion:** Sclera, just posterior to the cornea.
*   **Innervation:**
...
*   **Superior Oblique:**
    *   **Origin:** Lesser wing of sphenoid.
    *   **Course:** Passes through the **trochlea** (muscular sling), redirects posterolaterally.
    *   **Insertion:** Superior sclera.
    *   **Innervation:** Trochlear nerve (CN IV).
*   **Inferior Oblique:**
    *   **Origin:** Medial side of orbit.
    *   **Course:** Passes laterally and posteriorly.
    *   **Insertion:** Inferior sclera (deep to lateral rectus).
    *   **Innervation:** Oculomotor nerve (CN III).

### Innervation Mnemonic: SO4LR6AO3
*   **SO4:** Superior Oblique - CN IV (Trochlear).
*   **LR6:** Lateral Rectus - CN VI (Abducens).
*   **AO3:** All Others - CN III (Oculomotor).

## Part 3: Eye Movements

### Terminology
*   **Primary Position:** Looking straight ahead.
*   **Elevation:** Eye looking upward.
*   **Depression:** Eye looking downward.
*   **Adduction:** Eye looking medially (toward nose).
*   **Abduction:** Eye looking laterally.
*   **Intorsion:** Eye rotating medially.
*   **Extorsion:** Eye rotating laterally.

### Simple Movements (Abducted/Adducted Eye)
*   **Abducted Eye:**
...
### Complex Movements (Primary Position)
*   **Axis of Orbit vs. Axis of Eyeball:** Often offset, causing complexity.
*   **Torsion:** Occurs when axes are not aligned. Can be desired (tilting head) or avoided (smooth elevation/depression).
*   **Elevation (Primary Position):** Superior Rectus + Inferior Oblique (torsion cancels out).
*   **Depression (Primary Position):** Inferior Rectus + Superior Oblique (torsion cancels out).
*   **Intorsion:** Superior Rectus + Superior Oblique (elevation/depression cancel out).
*   **Extorsion:** Inferior Rectus + Inferior Oblique (elevation/depression cancel out).

## Part 4: Clinical Testing (H-Pattern)

### Testing Extraocular Muscles
*   **Goal:** Move eye out of primary position to test each muscle individually.
*   **H-Pattern:** Patient follows finger/light in an H-shape.
    *   **Adduct:** Medial Rectus.
    *   **Depress Adducted Eye:** Superior Oblique.
    *   **Elevate Adducted Eye:** Inferior Oblique.
    *   **Abduct:** Lateral Rectus.
    *   **Depress Abducted Eye:** Inferior Rectus.
...
`,
    questions: [
      {
        question: "A patient presents with diplopia after blunt trauma to the left eye. CT scan reveals a fracture of the orbital floor. Which bone is most likely involved?",
        options: [
          "Frontal",
          "Zygomatic",
          "Maxilla",
        ...
        correctAnswer: 2,
        rationale: "The orbital floor is primarily formed by the Maxilla (and a small part of the Zygomatic and Palatine bones). It is one of the weakest parts of the orbit and prone to 'blowout' fractures, which can entrap the inferior rectus muscle."
      },
      {
        question: "A 65-year-old male presents with his right eye resting in a 'down and out' position. He also has severe ptosis and a dilated pupil on the right. Which cranial nerve is most likely lesioned?",
        options: [
          "Optic Nerve (CN II)",
          "Oculomotor Nerve (CN III)",
        ...
        correctAnswer: 1,
        rationale: "This is a classic presentation of a CN III (Oculomotor) palsy. The unopposed action of the Superior Oblique (CN IV) and Lateral Rectus (CN VI) pulls the eye down and out. Loss of levator palpebrae causes ptosis, and loss of parasympathetics causes mydriasis."
      },
      {
        question: "A patient complains of double vision when walking down stairs. Physical exam reveals that the patient tilts their head to the LEFT to compensate for a right-sided eye problem. Which muscle is paralyzed?",
        options: [
        ...
        correctAnswer: 2,
        rationale: "This describes a Right CN IV (Trochlear) palsy, paralyzing the Superior Oblique. The Superior Oblique depresses the adducted eye (looking down/stairs). The patient tilts their head AWAY from the lesion (Bielschowsky sign) to compensate for the loss of intorsion."
      },
      {
        question: "Which extraocular muscle is primarily responsible for depressing the eye when it is in an adducted position?",
        options: [
          "Inferior Rectus",
          "Superior Oblique",
          "Inferior Oblique",
        ...
        correctAnswer: 1,
        rationale: "The Superior Oblique is the primary depressor of the adducted eye. The Inferior Rectus depresses the abducted eye."
      },
      {
        question: "Which of the following extraocular muscles is innervated by the Abducens Nerve (CN VI)?",
        options: [
          "Superior Oblique",
          "Medial Rectus",
          "Lateral Rectus",
        ...
        correctAnswer: 2,
        rationale: "The Lateral Rectus is innervated by CN VI (Abducens), which abducts the eye. Remember the mnemonic: SO4 LR6 AO3."
      }
    ],
    glossary: [
      { term: "Blowout Fracture", definition: "Fracture of the orbit where contents herniate into adjacent paranasal sinuses due to trauma." },
      { term: "Trochlea", definition: "A fibrous sling through which the superior oblique muscle passes, redirecting its fibers." },
      { term: "Common Tendinous Ring", definition: "The origin point for the four rectus muscles, attached to the lesser wing of the sphenoid." },
      { term: "Ptosis", definition: "Drooping of the upper eyelid, often due to oculomotor nerve damage." },
      { term: "Bielschowsky Sign", definition: "Elevation of the eye when the head is tilted to the affected side, indicating trochlear nerve lesion." }
    ]
  },
  {
    id: 'l128',
    ...
    createdAt: new Date('2024-11-26'),
    ankingResource: {'primarySource': 'Pathoma', 'chapter': '01_Fundamentals > 01_Cell_Adaptation,_Injury,_and_Death', 'alternatives': [{'resource': 'Physeo', 'chapter': '11_Pathology > 08_Renal_Pathology > 01_Acute_Kidney_Injury'}, {'resource': 'B&B', 'chapter': '16_Pathology > 01_Cellular_Adaptations'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 09_Carcinogenesis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 02_Hypertension'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 06_Endocrine_Pancreas'}, {'resource': 'Physeo', 'chapter': '05_Biochem > 02_Cellular_Biology > 03_Connective_Tissue'}, {'resource': 'B&B', 'chapter': '06_Cell_Bio > 03_Cellular > 04_Connective_Tissue'}, {'resource': 'B&B', 'chapter': '06_Cell_Bio > 03_Cellular > 03_Cytoskeleton'}, {'resource': 'SketchyPath', 'chapter': '06_Hepatobiliary > 02_Liver_Disease > 04_Liver_Tumors_&_Hepatocellular_Carcinoma'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 01_Acute_Kidney_Injury > 02_Acute_Tubular_Necrosis_(ATN)'}, {'resource': 'B&B', 'chapter': '06_Cell_Bio > 03_Cellular > 02_Cell_Structure'}, {'resource': 'B&B', 'chapter': '16_Pathology > 05_Necrosis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 02_Adrenal_Disorders > 02_Congenital_Adrenal_Hyperplasia_(CAH)'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 01_Cyclophosphamide,_ifosfamide,_busulfan,_nitrosoureas_(carmustine,_lomustine,_streptozocin)'}, {'resource': 'Bootcamp', 'chapter': 'Pathology > Cellular_Injury_&_Neoplasia > Dysplasia_and_Neoplasia'}, {'resource': 'SketchyPath', 'chapter': '06_Hepatobiliary > 01_Gallbladder_&_Biliary_Tract_Disease > 01_Lab_Evaluation_of_Liver_Injury_&_Hyperbilirubinemia'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 03_Bleomycin,_doxorubicin,_daunorubicin,_actinomycin_D'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 01_Cyclophosphamide,_ifosfamide,_busulfan,_nitrosoureas_(carmustine,_lomustine,_streptozocin) > zanki_extra'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 05_Male_GU > 02_Benign_Prostatic_Hyperplasia_(BPH)_&_Prostate_Cancer'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 05_Vincristine,_vinblastine,_paclitaxel'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > 02_Dna_&_Cellular_Division > 03_Bleomycin,_doxorubicin,_daunorubicin,_actinomycin_D > zanki_extra'}]},
    summary: `
...
Cells are constantly exposed to stress. To survive, they must adapt. If the stress is excessive or the cell cannot adapt, injury occurs.

### Hypertrophy
**Hypertrophy** is an increase in the **size** of cells, leading to an increase in the size of the organ.
*   **Key Point:** Occurs in **permanent tissues** (skeletal muscle, cardiac muscle, nerve tissue) that **cannot proliferate**. These cells can only get bigger via hypertrophy.
*   **Physiologic:** Uterus during pregnancy, skeletal muscle in bodybuilders.
*   **Pathologic:** Cardiac hypertrophy in hypertension (left ventricle works harder against resistance), aortic stenosis.
*   **Mechanism:** Mechanical sensors and growth factors activate signaling pathways (PI3K/AKT, GPCRs) -> increased protein synthesis.

### Hyperplasia
**Hyperplasia** is an increase in the **number** of cells. It occurs in tissues capable of replication.
*   **Physiologic:** Breast development at puberty/pregnancy, liver regeneration.
*   **Pathologic:** Benign Prostatic Hyperplasia (BPH), Endometrial Hyperplasia (inappropriate/excessive hormonal stimulation).
...
*   **Causes:** Disuse (cast), loss of innervation, diminished blood supply, inadequate nutrition, loss of endocrine stimulation (menopause).
*   **Mechanism:** Decreased protein synthesis and increased protein degradation (Ubiquitin-Proteasome pathway). Autophagy also plays a role.

### Metaplasia
**Metaplasia** is a reversible change where one adult cell type is replaced by another adult cell type better able to withstand the stress.
*   **Example:** In smokers, the fragile ciliated columnar epithelium of the trachea is replaced by tough stratified squamous epithelium.
...
## Part 2: Cellular Injury and Death

If adaptation fails, injury ensues.
...
3.  **Karyolysis:** Fading of the nucleus (digestion by DNase).

-----

## Part 3: Patterns of Tissue Necrosis

### Coagulative Necrosis
*   **Cause:** Ischemia (infarction).
*   **Features:** Architecture is preserved for days (ghost cells). Proteins denature.
*   **Location:** All solid organs (Heart, Kidney, Spleen) **EXCEPT the brain**.

### Liquefactive Necrosis
*   **Cause:** Bacterial/Fungal infections, or Ischemia in the **Brain**.
*   **Features:** Digestion of dead cells results in a liquid viscous mass (pus).

### Caseous Necrosis
*   **Cause:** Tuberculosis (TB).
*   **Features:** "Cheese-like" friable white appearance. Granuloma formation.

### Fat Necrosis
*   **Cause:** Acute Pancreatitis or trauma to breast.
*   **Features:** Chalky white deposits (saponification) due to fatty acids combining with calcium.

### Fibrinoid Necrosis
*   **Cause:** Immune complex deposition (Vasculitis, Malignant Hypertension).
*   **Features:** Bright pink amorphous appearance in vessel walls.

-----

## Part 4: Apoptosis

**Apoptosis** is programmed cell death. It is tightly regulated and does **NOT** elicit inflammation (unlike necrosis).
*   **Physiologic:** Embryogenesis (webbed fingers), hormone withdrawal (menstruation), elimination of self-reactive lymphocytes.
*   **Pathologic:** DNA damage (radiation), accumulation of misfolded proteins.

### Mechanisms
1.  **Intrinsic (Mitochondrial) Pathway:** Triggered by cell injury/stress. **Bcl-2** family sensors activate **Bax/Bak**, creating channels in the mitochondria. **Cytochrome c** leaks out and activates **Caspase 9**.
2.  **Extrinsic (Death Receptor) Pathway:** Triggered by receptor-ligand interactions (Fas/FasL, TNF). Activates **Caspase 8**.

Both pathways converge on **Executioner Caspases (3, 6, 7)** which chew up the cytoskeleton and DNA.

-----

## Part 5: Intracellular Accumulations (Pigments)

Cells may accumulate abnormal amounts of various substances:

### Anthracosis
*   **What:** Carbon/coal dust accumulation
*   **Where:** Lungs
*   **Who:** Heavy smokers, people in polluted areas, coal miners
*   **Appearance:** Black pigment in lung tissue and lymph nodes

### Hemosiderin
*   **What:** Iron-containing pigment derived from hemoglobin
*   **Where:** Sites of old hemorrhage, liver, spleen
*   **Stain:** Prussian blue (iron stain)
*   **Clinical:** Seen in bruises, hemochromatosis

### Lipofuscin
*   **What:** "Wear and tear" pigment
...
**Rationale**: The heart is composed of permanent cells (cardiac myocytes) that cannot divide. Therefore, in response to increased workload (hypertension), the cells must increase in **size** (hypertrophy) rather than number (hyperplasia).
</details>

---

**2. A 45-year-old woman presents with severe abdominal pain. Laboratory tests show elevated pancreatic enzymes (amylase and lipase). Which type of necrosis is most likely to be found in the peripancreatic fat?**
...
**Rationale**: Acute pancreatitis leads to the release of activated pancreatic enzymes that digest adipose tissue. The released fatty acids combine with calcium to form chalky white deposits (saponification), characteristic of **fat necrosis**.
</details>

---

**3. Which of the following is a feature of irreversible cell injury?**
...
**Answer: D (Membrane defects)**

**Rationale**: **Membrane damage** (plasma membrane, mitochondrial membrane, lysosomal membrane) is a hallmark of **irreversible** injury. Cellular swelling, fatty change, ribosomal detachment, and loss of microvilli are typically reversible if the stress is removed.
</details>

---

**4. A 30-year-old man presents with a chronic cough and weight loss. A chest X-ray shows a cavitary lesion in the upper lobe of the right lung. Biopsy reveals a granuloma with a central area of amorphous, granular debris. What type of necrosis is this?**
...
**Rationale**: **Caseous necrosis** is characteristic of **tuberculosis**. It appears "cheese-like" (white and friable) and is often associated with granulomas.
</details>

---

**5. Which of the following molecules is a key initiator of the intrinsic (mitochondrial) pathway of apoptosis?**
...
**Rationale**: The **intrinsic pathway** is triggered by mitochondrial damage, leading to the leakage of **cytochrome c** into the cytoplasm. Cytochrome c binds to Apaf-1 and activates **Caspase 9**. Fas ligand and TNF are involved in the extrinsic pathway (Caspase 8).
    ...
    "mnemonics": [
      {
        "heading": "Card #1",
        "mnemonic": "Chronic bronchitis is characterized by hypertrophy/hyperplasia of bronchial mucinous glands",
        "meaning": "mucinous"
      },
      {
        "heading": "Card #2",
        "mnemonic": "What is the effect of chronic gastritis on gastric HCl secretion?    Decreased (achlorhydria or hypochlorhydria)",
        "meaning": "Decreased (achlorhydria or hypochlorhydria)"
      },
      {
        "heading": "Card #3",
        "mnemonic": "Hypertrophy::(hypertrophy or hyperplasia) involves gene activation, protein synthesis, and production of organelles",
        "meaning": "Hypertrophy::(hypertrophy or hyperplasia)"
      },
      {
        "heading": "Card #4",
        "mnemonic": "Hyperplasia::(hypertrophy or hyperplasia) involves the controlled proliferation of stem cells and differentiated cells",
        "meaning": "Hyperplasia::(hypertrophy or hyperplasia)"
      },
      {
        "heading": "Card #5",
        "mnemonic": "Do permanent tissues (e.g. cardiac muscle, skeletal muscle, nerve) undergo hypertrophy and/or hyperplasia?   Hypertrophy, only",
        "meaning": "Hypertrophy, only"
      },
      {
        "heading": "Card #6",
        "mnemonic": "Atrophy via decrease in cell number occurs via apoptosis",
        "meaning": "apoptosis"
      },
      {
        "heading": "Card #7",
        "mnemonic": "Which cellular change is characterized by disordered, non-neoplastic cellular growth?    Dysplasia",
        "meaning": "Dysplasia"
      },
      {
        "heading": "Card #8",
        "mnemonic": "Which cellular adaptation is usually preceded by persistent metaplasia or pathologic hyperplasia?   Dysplasia",
        "meaning": "Dysplasia"
      },
      {
        "heading": "Card #9",
        "mnemonic": "Hemodynamic changes of an atherosclerotic myocardial infarction include:   1. Hypertrophy::hypertrophy or atrophy 2. Dilation::constriction or dilation 3. High::High or Low left ventricular end-dia...",
        "meaning": "Hypertrophy::hypertrophy or atrophy, Dilation::constriction or dilation, High::High or Low, left ventricular end-diastolic pressure"
      },
      {
        "heading": "Card #10",
        "mnemonic": "Thyroid-stimulating hormone (TSH) has a trophic effect on the thyroid gland, thus, chronic elevation of TSH causes hypertrophy/hyperplasia of the thyroid gland",
        "meaning": "hypertrophy/hyperplasia"
      },
      {
        "heading": "Card #11",
        "mnemonic": "Chronically elevated levels of ACTH cause hypertrophy/hyperplasia of the adrenal cortex",
        "meaning": "hypertrophy/hyperplasia"
      },
      {
        "heading": "Card #12",
        "mnemonic": "What is the state of the adrenal glands in Cushing syndrome due to exogenous corticosteroids?    Atrophy of both adrenal glands::hyperplasia, atrophy; one, both",
        "meaning": "Atrophy of both adrenal glands::hyperplasia, atrophy; one, both"
      },
      {
        "heading": "Card #13",
        "mnemonic": "What is the state of the adrenal glands in Cushing syndrome due to primary adrenal adenoma, hyperplasia, or carcinoma?   Atrophy of the uninvolved gland; hyperplasia of the involved gland::hyperpla...",
        "meaning": "Atrophy of the uninvolved gland; hyperplasia of the involved gland::hyperplasia, atrophy; one, both"
      },
      {
        "heading": "Card #14",
        "mnemonic": "What is the state of the adrenal glands in Cushing syndrome due to ACTH secreting pituitary adenoma?   Hyperplasia of both adrenal glands::hyperplasia, atrophy; one, both",
        "meaning": "Hyperplasia of both adrenal glands::hyperplasia, atrophy; one, both"
      },
      {
        "heading": "Card #15",
        "mnemonic": "What is the state of the adrenal glands in Cushing syndrome due to a paraneoplastic (ectopic) ACTH secretion?   Hyperplasia of both adrenal glands::hyperplasia, atrophy; one, both",
        "meaning": "Hyperplasia of both adrenal glands::hyperplasia, atrophy; one, both"
      }
    ]
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'Pathoma', 'chapter': '02_Inflammation > 01_Acute_Inflammation', 'alternatives': [{'resource': 'Pathoma', 'chapter': '02_Inflammation > 02_Chronic_Inflammation'}, {'resource': 'B&B', 'chapter': '16_Pathology > 06_Inflammation'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 09_Carcinogenesis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 02_Hypertension'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 06_Endocrine_Pancreas'}, {'resource': 'SketchyPharm', 'chapter': '03_Blood_&_Inflammation > 03_Anti-inflammatory > 01_NSAIDs'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 08_Renal_Pathology > 01_Acute_Kidney_Injury'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 06_Gastrointestinal_Pathology > 05_Small_Bowel'}, {'resource': 'FirstAid', 'chapter': '08_Endocrine > 04_Pathology > 15_Diabetes_Mellitus'}, {'resource': 'B&B', 'chapter': '16_Pathology > 07_Acute_&_Chronic_Inflammation'}, {'resource': 'FirstAid', 'chapter': '07_Cardiovascular > 04_Pathology > 01_Congenital_Heart_Diseases'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 03_Pathology > 14_Neurodegenerative_Disorders'}, {'resource': 'FirstAid', 'chapter': '14_Renal > 04_Pathology > 04_Nephritic_Syndrome'}, {'resource': 'SketchyPharm', 'chapter': '03_Blood_&_Inflammation > 02_Dyslipidemia_Drugs > 01_Statins'}, {'resource': 'FirstAid', 'chapter': '16_Respiratory > 04_Pathology > 24_Lung_Cancer'}, {'resource': 'B&B', 'chapter': '16_Pathology > 11_Neoplasia'}, {'resource': 'B&B', 'chapter': '16_Pathology > 08_Granulomatous_Inflammation'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'SketchyPharm', 'chapter': '03_Blood_&_Inflammation > 03_Anti-inflammatory > 02_Gout_drugs > zanki_extra'}, {'resource': 'SketchyPharm', 'chapter': '03_Blood_&_Inflammation > 01_Anticoagulants_&_Thrombolytics > 03_Antiplatelet_agents'}, {'resource': 'SketchyPharm', 'chapter': '03_Blood_&_Inflammation > 01_Anticoagulants_&_Thrombolytics > 01_Heparin,_LMWH,_fondaparinux,_direct_thrombin_inhibitors,_Xa_inhibitors'}, {'resource': 'SketchyPath', 'chapter': '10_Myeloid_&_Lymphoid > 02_Lymphoid_&_Plasma_Cell_Disorders > 01_Acute_Lymphoblastic_Leukemia_(ALL),_Chronic_Lymphocytic_Leukemia_(CLL),_Hairy_Cell_Leukemia_&_Adult_T-cell_Leukemia'}, {'resource': 'B&B', 'chapter': '14_MSK > 03_Pathology > 07_Gout_Drugs'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'SketchyPath', 'chapter': '05_GI > 01_Esophageal_&_Gastric_Disorders > 03_Acute_&_Chronic_Gastritis_&_Peptic_Ulcer_Disease'}, {'resource': 'SketchyPath', 'chapter': '10_Myeloid_&_Lymphoid > 01_Myeloid_Disorders > 02_Acute_Myeloid_Leukemia_(AML)_&_Chronic_Myeloid_Leukemia_(CML)'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > Pulmonary_Hypertension'}, {'resource': 'SketchyPath', 'chapter': '04_Renal > 03_Congenital_&_Chronic_Kidney_Disease > 01_Congenital_&_Cystic_Kidney_Disease'}, {'resource': 'SketchyPath', 'chapter': '06_Hepatobiliary > 03_Pancreatic_Disease > 01_Acute_&_Chronic_Pancreatitis'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 05_Cytokines > 03_IL-2'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 05_Cytokines > 01_TNF-alpha'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 06_Immunodeficiencies > 06_Chronic_Granulomatous_Disease_(CGD)'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 05_Cytokines > 02_IL-1'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 05_Cytokines > 13_IFN-gamma'}]},
    summary: `
...
## Overview
*   **Definition:** A protective response to cell injury (infection, necrosis, trauma, etc.) intended to eliminate the cause and repair tissue.
...
## Acute Inflammation
*   **Vascular Changes:**
    *   **Vasodilation:** Increased blood flow (Histamine, NO).
    *   **Increased Permeability:** Leakage of fluid and proteins (Exudate).
        *   **Transudate:** Low protein, low cellularity (Hydrostatic/Oncotic imbalance).
        *   **Exudate:** High protein, high cellularity (Inflammation/Permeability).
    *   **Stasis:** Slowed blood flow, allowing leukocytes to marginate.
...
*   **Neutrophils:** Most predominant around **24 hours**. First responders in acute inflammation and acute bacterial infections.
*   **Macrophages:** Most predominant around **48-72 hours**.
*   **Granulation Tissue:** Present by **5-7 days** (new blood vessels/angiogenesis, macrophages, fibroblasts producing collagen).
*   **Fibrous Scar:** After **1-2 months** (especially in permanent tissue and large skin wounds).

## Types of Acute Inflammation
*   **Serous:** Mild, protein-poor fluid (e.g., blister from burn).
*   **Fibrinous:** Protein-rich exudate with fibrin (e.g., pericarditis, pleuritis).
*   **Suppurative (Purulent):** Pus formation (neutrophils + necrotic debris). Examples: Abscess, Empyema.
...
*   **Bradykinin:** Pain, Vasodilation, Permeability.

## Chronic Inflammation
*   **Duration:** Prolonged (weeks/months).
...
## Clinical Notes
*   **CD Markers:** Low numbers (<10) = T lymphocytes (CD4, CD8). CD10, CD19, CD20 = B lymphocytes.
...
`,
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Bradykinin and Prostaglandins (specifically PGE2) are the primary mediators responsible for pain (dolor) in acute inflammation."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Selectins (L-selectin, E-selectin, P-selectin) mediate the weak, transient interactions that cause leukocytes to 'roll' along the endothelium."
      },
      {
        ...
        correctAnswer: 3,
        rationale: "NADPH oxidase is essential for the respiratory burst that generates reactive oxygen species (superoxide) used for intracellular killing of microbes. Deficiency leads to Chronic Granulomatous Disease (CGD)."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Granuloma formation is a specific type of chronic inflammation characterized by aggregates of activated macrophages (epithelioid cells), often with giant cells and lymphocytes."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "C3b acts as an opsonin, coating microbes to enhance their recognition and phagocytosis by leukocytes expressing C3b receptors."
      }
    ],
    glossary: [
    ...
    "mnemonics": [
      {
        "heading": "Card #1",
        "mnemonic": "What cytokine is produced by macrophages to recruit neutrophils for persistent acute inflammation?   IL-8",
        "meaning": "IL-8"
      },
      {
        "heading": "Card #2",
        "mnemonic": "Mechanisms of Anemia of Chronic Disease  Inflammation in chronic disease leads to increased neutrophils, granulocytes and macrophages. These leukocytes secrete cytokines (ex: IL-6) which stimulate the liver to produce acute phase reactants (ex: hepcidin)    Hepcidin decreases gut iron absorption by",
        "meaning": "6, hepcidin, Hepcidin, ferroportin::what transfer protein, macrophages::what phagocyte/WBC"
      },
      {
        "heading": "Card #3",
        "mnemonic": "What histological findings are associated with Subacute thyroiditis (de Quervain)?   Granulomatous inflammation",
        "meaning": "Granulomatous inflammation"
      },
      {
        "heading": "Card #4",
        "mnemonic": "What microscopic changes occur from 3 - 10 days post-MI?    Macrophage infiltration  (acute inflammation)*",
        "meaning": "Macrophage infiltration  (acute inflammation)*"
      },
      {
        "heading": "Card #5",
        "mnemonic": "Emphysema may be caused by excessive inflammation/proteases::general or  lack of α1-antitrypsin",
        "meaning": "inflammation/proteases::general, α1-antitrypsin"
      },
      {
        "heading": "Card #6",
        "mnemonic": "Acute inflammation is characterized by the presence of edema and neutrophils::cell type in tissue",
        "meaning": "neutrophils::cell type"
      },
      {
        "heading": "Card #7",
        "mnemonic": "Acute inflammation may result in abscess formation, which is acute inflammation surrounded by fibrosis",
        "meaning": "abscess"
      },
      {
        "heading": "Card #8",
        "mnemonic": "Which cytokine is responsible for maintaining granulomas in TB infection?    TNF-α (from macrophages)",
        "meaning": "TNF-α (from macrophages)"
      },
      {
        "heading": "Card #9",
        "mnemonic": "Key differences between Neutrophils & Macrophages: Neutrophil or Macrophage? - Chronic inflammation/infection  Macrophage",
        "meaning": "Macrophage"
      },
      {
        "heading": "Card #10",
        "mnemonic": "TNF, IL-1, and IL-6 are cytokines in acute inflammation. IL-12, IFN-gamma, and IL-17 are cytokines in chronic inflammation.",
        "meaning": "TNF, IL-1, and IL-6, acute inflammation, IL-12, IFN-gamma, and IL-17, chronic inflammation."
      },
      {
        "heading": "Card #11",
        "mnemonic": "The classically activated macrophages (M1) comes from interferon-gamma or microbial products. It kills via ROS, NOS, and lysosomal enzymes in acute inflammation. In chronic inflammation, it secretes IL-1, IL-12, and IL-23 (which potentiate the inflammatory reaction).   The alternatively activated ma",
        "meaning": "classically activated macrophages (M1), alternatively activated macrophages (M2)"
      },
      {
        "heading": "Card #12",
        "mnemonic": "Cutaneous Injury Wound Healing Phase 1: Inflammation::inflammation, proliferation, naturation  •Immediate→ 2-5 days  •Bleeding stops- constriction of vessels, formation of clot  •Triggers for acute inflammation:  –Cell damage, bacteria, and clotting cascade  •Acute inflammation- vasodilation, phagoc",
        "meaning": "Inflammation::inflammation, proliferation, naturation, 2, 5, clot, clotting"
      },
      {
        "heading": "Card #13",
        "mnemonic": "The following describes Macrophages::Macrophages or Neutrophils: i.Long lived  ii.Chronic inflammation/infection  iii.Less microbicidal and cytotoxic  iv.Recruit neutrophils  v.Requires activation by PRRs  vi.Display a higher degree of specificity which makes them better suited as sentinels of the i",
        "meaning": "Macrophages::Macrophages or Neutrophils"
      },
      {
        "heading": "Card #14",
        "mnemonic": "5 steps of Normal Response in Host Defense:-Migration of leukocytes to antigen site    -Non-specific::non-specific or specific recognition of antigen by macrophages and other parts of Innate system    -Specific::non-specific or specific recognition of foreign antigen conducted by T and B lymphocytes",
        "meaning": "Migration, Non-specific::non-specific or specific, Specific::non-specific or specific, Amplification, Neutralization"
      },
      {
        "heading": "Card #15",
        "mnemonic": "What microscopic changes occur from 1 - 3 days post-MI?    Neutrophils (acute inflammation)",
        "meaning": "Neutrophils (acute inflammation)"
      }
    ]
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'Pathoma', 'chapter': '02_Inflammation > 03_Tissue_Regeneration_and_Repair', 'alternatives': [{'resource': 'B&B', 'chapter': '16_Pathology > 09_Wound_Healing_&_Scars'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 09_Carcinogenesis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 02_Hypertension'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 06_Endocrine_Pancreas'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 07_Wound_Healing'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 06_Gastrointestinal_Pathology > 05_Small_Bowel'}, {'resource': 'B&B', 'chapter': '16_Pathology > 11_Neoplasia'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'B&B', 'chapter': '14_MSK > 03_Pathology > 07_Gout_Drugs'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'B&B', 'chapter': '16_Pathology > 06_Inflammation'}, {'resource': 'B&B', 'chapter': '16_Pathology > 03_Free_Radicals'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > Pulmonary_Hypertension'}, {'resource': 'SketchyPath', 'chapter': '11_Immunology > 01_Autoimmune_&_Amyloidosis > 02_Sjogrens_Syndrome,_Systemic_Sclerosis_&_Mixed_Connective_Tissue_Disease'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 01_Parasympathetic > 03_Muscarinic_antagonists'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 05_Helminths_-_Nematodes > 01_Enterobius_vermicularis,_Ancylostoma_duodenale,_Necator_americanus,_Ascaris_lumbricoides,_Strongyloides_stercoralis,_Trichinella_spiralis_(intestinal_nematodes)'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 05_Helminths_-_Nematodes > 02_Dracunculus_medinensis,_Wuchereria_bancrofti,_Onchocerca_volvulus,_Toxocara_canis,_Loa_loa_(tissue_nematodes)'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 07_Antivirals_Other > 03_Ganciclovir,_valganciclovir,_foscarnet,_cidofovir'}, {'resource': 'Pixorize', 'chapter': '04_Micro > 03_Antivirals > Foscarnet'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 11_DNA_Repair > 02_Xeroderma_Pigmentosum'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 11_DNA_Repair > 01_Lynch_Syndrome'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 07_Antivirals_Other > 03_Ganciclovir,_valganciclovir,_foscarnet,_cidofovir > zanki_extra'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 10_Collagen_Related_Disorders > 05_Ehlers-Danlos_Syndrome'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 04_Protozoa_-_Other_Tissue > 01_Trichomonas_vaginalis'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 10_Collagen_Related_Disorders > 06_Goodpasture_Syndrome'}]},
    summary: `
...
`,
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Hepatocytes are stable cells (quiescent) that can re-enter the cell cycle and proliferate in response to injury or tissue loss."
      },
      {
        ...
        correctAnswer: 0,
        rationale: "Granulation tissue is the hallmark of the proliferative phase, consisting of new blood vessels (angiogenesis), fibroblasts, and inflammatory cells in a loose matrix."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "TGF-beta is the most important cytokine for the synthesis and deposition of connective tissue proteins (fibrosis)."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Keloids are characterized by excessive scar tissue formation that grows beyond the boundaries of the original wound. Hypertrophic scars remain confined to the wound."
      },
      {
        ...
        correctAnswer: 0,
        rationale: "Type III collagen (immature) is replaced by Type I collagen (mature, high tensile strength) during the remodeling/maturation phase."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'Pathoma', 'chapter': '03_Principles_of_Neoplasia > 01_Neoplasia', 'alternatives': [{'resource': 'Pathoma', 'chapter': '03_Principles_of_Neoplasia > 02_Carcinogenesis'}, {'resource': 'B&B', 'chapter': '16_Pathology > 11_Neoplasia'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 09_Carcinogenesis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 02_Hypertension'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 06_Endocrine_Pancreas'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 06_Gastrointestinal_Pathology > 05_Small_Bowel'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 03_Pulmonary_Pathology > 20_Lung_Cancer'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'B&B', 'chapter': '14_MSK > 03_Pathology > 04_Bone_Tumors'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'B&B', 'chapter': '14_MSK > 03_Pathology > 07_Gout_Drugs'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 01_Uterine_&_Vulvovaginal_Disorders > 02_Cervical_Neoplasia'}, {'resource': 'B&B', 'chapter': '16_Pathology > 06_Inflammation'}, {'resource': 'B&B', 'chapter': '16_Pathology > 03_Free_Radicals'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Malignant_Esophageal_Disorders'}, {'resource': 'SketchyPath', 'chapter': '12_MSK_&_Derm > 01_Bone > 04_Malignant_Bone_Tumors'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 04_Breast > 01_Benign_Breast_Disorders'}, {'resource': 'SketchyPath', 'chapter': '12_MSK_&_Derm > 01_Bone > 03_Benign_Bone_Tumors'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors > 01_Craniopharyngioma'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors > 06_Ependymoma'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors > 07_Pinealoma'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors > 03_Schwannoma'}]},
    summary: `
# Lecture #131: Pathology: Introduction to Neoplasia Part 1
...
`,
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Metastasis (spread to distant sites) is the unequivocal hallmark of malignancy. Benign tumors do not metastasize."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Anaplasia refers to a lack of differentiation, which is a hallmark of malignant tumors."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Melanoma is a malignant tumor of melanocytes. Other examples include lymphoma, mesothelioma, and seminoma."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "TNM stands for Tumor (size/extent), Node (regional lymph node involvement), and Metastasis (distant spread)."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "High-risk strains of HPV (e.g., 16 and 18) are the primary cause of cervical carcinoma."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'Pathoma', 'chapter': '03_Principles_of_Neoplasia > 02_Carcinogenesis', 'alternatives': [{'resource': 'Pathoma', 'chapter': '03_Principles_of_Neoplasia > 03_Tumor_Progression_and_Metastasis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 03_Pulmonary_Pathology > 20_Lung_Cancer'}, {'resource': 'B&B', 'chapter': '16_Pathology > 11_Neoplasia'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 07_General_Pathology > 09_Carcinogenesis'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 02_Hypertension'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 02_Endocrine_Pathology > 06_Endocrine_Pancreas'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 06_Gastrointestinal_Pathology > 05_Small_Bowel'}, {'resource': 'B&B', 'chapter': '11_Hematology > 04_Cancer_Drugs > 01_Antimetabolites'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Hepatic_Pathology > Viral_Hepatitis'}, {'resource': 'Bootcamp', 'chapter': 'Gastroenterology > Esophageal_and_Gastric_Pathology > Gastritis_and_Peptic_Ulcers'}, {'resource': 'B&B', 'chapter': '18_Pulm > 03_Other > 03_Lung_Cancer'}, {'resource': 'B&B', 'chapter': '14_MSK > 03_Pathology > 07_Gout_Drugs'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 01_Uterine_&_Vulvovaginal_Disorders > 02_Cervical_Neoplasia'}, {'resource': 'B&B', 'chapter': '16_Pathology > 06_Inflammation'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > ARDS_and_NRDS'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 04_Breast > 02_Breast_Cancer'}, {'resource': 'SketchyPath', 'chapter': '05_GI > 03_Colorectal_&_Anal_Disorders > 03_Colorectal_Polyps_&_Cancer'}, {'resource': 'SketchyPath', 'chapter': '08_Repro_&_GU > 05_Male_GU > 01_Testicular_Disorders_&_Cancer'}, {'resource': 'SketchyPath', 'chapter': '03_Pulmonary > 04_Lung_Cancer > 01_Lung_Carcinoma'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Special_Topics > Pulmonary_Hypertension'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 12_Lung_Cancer > 03_Adenocarcinoma'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 12_Lung_Cancer > 02_Small_Cell_Carcinoma'}, {'resource': 'SketchyPharm', 'chapter': '08_Antineoplastics > Cancer_Immunotherapy'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 12_Lung_Cancer > 01_Lung_Cancer_Overview'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 12_Lung_Cancer > 06_Bronchial_Carcinoid_Tumor'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 12_Lung_Cancer > 04_Squamous_Cell_Carcinoma'}]},
    summary: `
# Lecture #132: Pathology: Introduction to Neoplasia Part 2

## Part 1: Genetic and Molecular Basis of Cancer
*   **Hallmarks of Malignancy (8 Key Features):**
    1.  **Proliferate without external stimuli (self-sufficiency in growth signals):** Oncogenes (e.g., *RAS*, *MYC*, *EGFR*) drive proliferation.
    2.  **Insensitive to growth-inhibitory signals:** Loss of Tumor Suppressor Genes (e.g., *RB*, *TP53*, *APC*).
    3.  **Metabolic switch to aerobic glycolysis (Warburg Effect):** Enables synthesis of macromolecules needed for fast cell growth (see below).
    4.  **Evade apoptosis:** Overexpression of anti-apoptotic proteins (e.g., *BCL2*) or loss of pro-apoptotic factors (*BAX*, *BAK*, *TP53*). Tumors are resistant to programmed cell death.
    5.  **Limitless proliferative capacity = Immortality:** Reactivation of **Telomerase** enzyme (present in 90% of cancers). Most somatic cells do not express telomerase.
    6.  **Sustained angiogenesis:** Secretion of VEGF to create new blood vessels for nutrient supply.
    7.  **Ability to invade and metastasize:** **THE DEFINITIVE CRITERION FOR MALIGNANCY.**
    8.  **Evade host immune response:** Antigen masking, MHC loss, immunosuppression.

### Important Regulatory Genes (4 Major Categories)
*   **Proto-oncogenes:** Involved in normal cell growth/repair (Abl, HER, Myc, Ras) - **growth promoting**.
*   **Tumor suppressor genes:** Protect against unregulated cell growth (APC, BRCA, p53) - **growth inhibiting**.
*   **DNA repair genes:** Maintain genomic stability (BRCA1/2, Mismatch repair).
*   **Anti-apoptosis genes:** Overexpression prevents apoptosis (Bcl-2); mutations prevent programmed cell death.

### Key Genes in Cancer (Know These 3!)
**1. RAS Oncogene (Signal Transducer)**
*   Most common proto-oncogene abnormality in humans (15-20% of all cancers).
*   **Types:** HRAS, KRAS, NRAS.
*   **Point mutation** = single most common abnormality.
*   **Associations:** KRAS (colon, pancreas), HRAS (bladder), NRAS (hematopoietic).
*   **Mechanism:** Normal RAS flips between active (GTP-bound) and inactive (GDP-bound). Mutated RAS is **permanently activated** (cannot hydrolyze GTP) → continuous proliferation signal.

**2. MYC Oncogene (Nuclear Regulator/Transcription Factor)**
*   Activates expression of many genes involved in cell growth.
*   **Deregulation mechanisms:**
    *   **Translocation** in Burkitt lymphoma.
    *   **Amplification** in breast, colon, lung cancers → overexpression.
    *   Sometimes upregulates telomerase (contributes to endless replication).
*   **Variants:** N-Myc (neuroblastoma), L-Myc (small cell lung cancer).

**3. p53 Tumor Suppressor Gene ("Molecular Policeman")**
*   **Location:** Chromosome 17.
*   **Mutated in >50% of tumors** - most common tumor suppressor gene mutation.
*   **Normal Functions:** Regulates cell cycle progression, DNA repair, senescence, apoptosis. Prevents neoplastic transformation via:
    *   Temporary cell cycle arrest (quiescence) via **p21**.
...
*   **Tumor Growth Kinetics:**
    *   **Doubling Time:** Time it takes for tumor mass to double.
    *   **Growth Fraction:** Proportion of cells actively dividing. Chemotherapy targets high growth fraction cells.
*   **Steps of Metastasis:**
    1.  **Invasion:** Loosening of cell-cell contacts (loss of E-cadherin), degradation of ECM (MMPs), migration.
    2.  **Intravasation:** Entering blood or lymph vessels.
    3.  **Survival in Circulation:** Evasion of immune system (antigen masking, MHC loss, immunosuppression).
    4.  **Extravasation:** Exiting vessels at distant site.
    5.  **Colonization:** Growth at secondary site (requires angiogenesis).
*   **Pathways of Spread:**
    *   **Lymphatic:** Typical for Carcinomas (spread to regional nodes).
    *   **Hematogenous:** Typical for Sarcomas (spread to lungs, liver, bone, brain). Also Renal Cell Carcinoma, Hepatocellular Carcinoma.
    *   **Seeding:** Spread within body cavities (e.g., Ovarian cancer in peritoneal cavity).

## Part 3: Oncogenic Microbes
*   **Viruses:**
    *   **HPV (Human Papillomavirus):** Cervical, anal, oropharyngeal cancers (E6 inhibits p53, E7 inhibits Rb).
    *   **EBV (Epstein-Barr Virus):** Burkitt lymphoma, Nasopharyngeal carcinoma, CNS lymphoma in HIV.
    *   **HBV/HCV (Hepatitis B/C):** Hepatocellular carcinoma.
    *   **HHV-8 (Kaposi Sarcoma Herpesvirus):** Kaposi sarcoma (in AIDS).
...
## Part 4: Paraneoplastic Syndromes
*   **Definition:** Symptom complexes that cannot be explained by the local or distant spread of the tumor or by the elaboration of hormones indigenous to the tissue of origin.
*   **Prevalence:** ~10% of persons with malignant disease.
*   **Significance:** May be **earliest manifestation** of occult neoplasm.
*   **Endocrine:**
    *   **Cushing Syndrome:** Ectopic ACTH production (Small cell lung cancer).
    *   **SIADH:** Ectopic ADH production (Small cell lung cancer) → hyponatremia.
    *   **Hypercalcemia:** PTHrP production (Squamous cell lung cancer, Breast, Renal).
*   **Neurologic:**
    *   **Anti-NMDA Receptor Encephalitis:** Ovarian teratoma.
    *   **Limbic Encephalitis:** Small cell lung cancer.
    *   **Lambert-Eaton Myasthenic Syndrome:** Antibodies against presynaptic Ca²⁺ channels (Small cell lung cancer).
...
`,
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Reactivation of telomerase maintains telomere length, preventing the cell from reaching the Hayflick limit and allowing for limitless replicative potential (immortality)."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Carcinomas typically spread via the lymphatics to regional lymph nodes first, whereas sarcomas tend to spread hematogenously."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "This describes Lambert-Eaton Myasthenic Syndrome, a paraneoplastic syndrome associated with small cell lung cancer caused by antibodies against presynaptic calcium channels."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "High-risk HPV strains express E6 (degrades p53) and E7 (inhibits Rb), promoting uncontrolled cell division."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "The Warburg Effect is the phenomenon where cancer cells preferentially use glycolysis for energy production even in the presence of ample oxygen (aerobic glycolysis)."
      }
    ],
    glossary: [
    ...
    "mnemonics": [
      {
        "heading": "Card #1",
        "mnemonic": "Cervical Intraepithelial Neoplasia (CIN) is a dysplastic pre-cancerous lesion of the cervix that commonly manifests following the loss of the tumor suppressors p53 and Rb following HPV infection",
        "meaning": "Cervical Intraepithelial Neoplasia (CIN), p53, Rb"
      },
      {
        "heading": "Card #2",
        "mnemonic": "Tumor suppressor genes regulate cell growth",
        "meaning": "regulate"
      },
      {
        "heading": "Card #3",
        "mnemonic": "Oncogenes in Pancreatic Carcinoma:  Inactivation of the TP53, SMAD4, and BRCA2 tumor suppressor genes occurs in high-grade pancreatic intraepithelial neoplasia that signal high grade cancer and precede invasive cancer",
        "meaning": "TP53"
      },
      {
        "heading": "Card #4",
        "mnemonic": "What tumor suppressor does the E7 protein from Human Papillomavirus (HPV) bind to and inhibit?   Rb (specifically p105-Rb)",
        "meaning": "Rb (specifically p105-Rb)"
      },
      {
        "heading": "Card #5",
        "mnemonic": "Which protein from high-risk HPV strains binds to p53?  E6",
        "meaning": "E6"
      },
      {
        "heading": "Card #6",
        "mnemonic": "If a patient inherits or develops a mutation in a(n) tumor suppressor gene, the complementary allele must be deleted/mutated before cancer develops",
        "meaning": "tumor suppressor"
      },
      {
        "heading": "Card #7",
        "mnemonic": "The MYCL1 proto-oncogene encodes for the nuclear regulator::class L-myc, which stimulates cell cycle progression",
        "meaning": "proto-oncogene, nuclear regulator::class"
      },
      {
        "heading": "Card #8",
        "mnemonic": "The G1 restriction point of the cell cycle is regulated by the tumor suppressors p53 and Rb",
        "meaning": "p53, Rb"
      },
      {
        "heading": "Card #9",
        "mnemonic": "The Knudson two-hit hypothesis states that both copy/copies of a tumor suppressor gene must be knocked out for tumor formation",
        "meaning": "both"
      },
      {
        "heading": "Card #10",
        "mnemonic": "One hallmark of cancer is the ability to have limitless replicative potential (ex. exceed the hayflick limit)",
        "meaning": "replicative"
      },
      {
        "heading": "Card #11",
        "mnemonic": "What is the mechanism that results in malignancy from the L-MYC oncogene?   amplification",
        "meaning": "amplification"
      },
      {
        "heading": "Card #12",
        "mnemonic": "What is the associated tumor that results from amplification of the L-MYC oncogene?   Small cell lung carcinoma",
        "meaning": "Small cell lung carcinoma"
      },
      {
        "heading": "Card #13",
        "mnemonic": "The Warburg effect states that cancers produce energy via a high rate of glycolysis followed by lactic acid fermentation",
        "meaning": "glycolysis, lactic acid"
      },
      {
        "heading": "Card #14",
        "mnemonic": "\"Li-Fraumeni Syndrome is also known as \"\"SBLA\"\" Syndrome, which stands for:   S - Sarcoma B - Breast Cancer L - Leukemia A - Adrenal Gland tumor\"",
        "meaning": "Sarcoma, Breast Cancer, Leukemia, Adrenal Gland tumor"
      },
      {
        "heading": "Card #15",
        "mnemonic": "Mutations in MYCL1 can cause Small Cell Lung Carcinoma due to a resultant amplification of the transcription factors activity (nuclear regulator)",
        "meaning": "Small Cell Lung, amplification"
      }
    ]
  },
  {
    ...
    createdAt: "2024-11-26",
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '03_Microbiology > 06_Systems > 13_Sexually_Transmitted_Infections', 'alternatives': [{'resource': 'B&B', 'chapter': '15_Neuro > 01_Intro > 01_Cells_of_the_Nervous_System'}, {'resource': 'Physeo', 'chapter': '08_Immunology > 01_Immunology > 18_B_Cells'}, {'resource': 'B&B', 'chapter': '12_Immunology > 01_Basic > 03_B-cells'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 04_Nephrology > 05_Renin-Angiotensin-Aldosterone_System'}, {'resource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 08_Thalamus,_Hypothalamus,_Limbic_System'}, {'resource': 'B&B', 'chapter': '12_Immunology > 01_Basic > 02_T-cells'}, {'resource': 'Pathoma', 'chapter': '18_MSK > 01_Skeletal_System'}, {'resource': 'B&B', 'chapter': '15_Neuro > 07_Other > 05_Demyelinating_Diseases'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 06_Thalamus,_Hypothalamus_&_Limbic_System'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Lung_Pathology_Fundamentals > Introduction_to_Respiratory_Infections'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 08_Basal_Ganglia_&_Dopaminergic_Pathways'}, {'resource': 'Bootcamp', 'chapter': 'Pulmonology > Introduction_to_the_Respiratory_System > Pulmonology_System_Function,_Anatomy,_and_Histology'}, {'resource': 'Physeo', 'chapter': '08_Immunology > 01_Immunology > 09_Cytokines_from_Macrophages_&_Dendritic_Cells'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 06_Demyelinating_Disorders'}, {'resource': 'SketchyPath', 'chapter': '11_Immunology > 01_Autoimmune_&_Amyloidosis > 01_Autoimmune_Disease:_Overview_&_Systemic_Lupus_Erythematosus_(SLE)'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 06_Demyelinating_Disorders > demyelinating_disorders-extra?'}, {'resource': 'SketchyPath', 'chapter': '11_Immunology > 01_Autoimmune_&_Amyloidosis > 02_Sjogrens_Syndrome,_Systemic_Sclerosis_&_Mixed_Connective_Tissue_Disease'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Demyelinating_Diseases > Multiple_Sclerosis'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Renin_Angiotensin_Aldosterone_System > Direct_Pharmacologic_Targets'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Renin_Angiotensin_Aldosterone_System > Regulation'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 09_T_Cells_-_Differentiation'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 13_Th2_Cells'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 03_B_Cells_-_Overview'}, {'resource': 'SketchyPath', 'chapter': '11_Immunology > 02_Immunodeficiency > 03_Complement_System_Disorders'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 01_Systemic_Mycoses > 01_Histoplasma_capsulatum'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 12_Th1_Cells'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 01_Systemic_Mycoses > 02_Blastomyces_dermatitidis'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 01_Systemic_Mycoses > 03_Coccidioides_immitis'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 01_MHC_I'}, {'resource': 'Pathoma', 'chapter': '16_Breast > 01_Introduction'}, {'resource': 'SketchyMicro', 'chapter': '02_Fungi > 01_Systemic_Mycoses > 04_Paracoccidioides_brasiliensis'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 06_Demyelinating_Disorders > demyelinating_disorders-extra'}]},
    summary: `
...
`,
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "Astrocytes become reactive following injury (gliosis) and upregulate GFAP, forming a glial scar."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Joubert syndrome is a ciliopathy caused by mutations in genes like ARL13B, affecting the neuronal primary cilium."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Nodes of Ranvier are gaps in the myelin sheath where voltage-gated ion channels are clustered to regenerate the action potential (saltatory conduction)."
      },
      {
        ...
        correctAnswer: 3,
        rationale: "Electrical synapses (gap junctions) allow direct, bidirectional, and very fast flow of ions and small molecules between cells."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "MOG is a protein found on the surface of oligodendrocytes and their myelin sheaths in the CNS. MOGAD is a demyelinating disease."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    ankingResource: {'primarySource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 06_Bias', 'alternatives': [{'resource': 'FirstAid', 'chapter': '06_Public_Health > 01_Epidemiology_&_Biostatistics > 10_Bias_&_Study_Errors'}, {'resource': 'FirstAid', 'chapter': '06_Public_Health > 01_Epidemiology_&_Biostatistics > 09_Incidence_vs_Prevalence'}, {'resource': 'FirstAid', 'chapter': '06_Public_Health > 01_Epidemiology_&_Biostatistics > 09_Incidence_vs_Prevalence > Prevalence > *Basics'}, {'resource': 'FirstAid', 'chapter': '06_Public_Health > 01_Epidemiology_&_Biostatistics > 04_Quantifying_risk'}, {'resource': 'FirstAid', 'chapter': '02_Immunology > 03_Immune_Responses > 13_Hypersensitivity_Types'}, {'resource': 'Physeo', 'chapter': '08_Immunology > 01_Immunology > 20_Hypersensitivity_Reactions'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 13_Psychiatric > 30_Opioid_Withdrawal,_Detoxification_and_Relapse_Prevention'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 08_Incidence,_Prevalence_&_Likelihood_Ratios'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 06_Sensitivity_&_Specificity'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 07_PPV_&_NPV'}, {'resource': 'Bootcamp', 'chapter': 'Immunology > Hypersensitivities > Type_I_Hypersensitivity_Reactions'}, {'resource': 'Bootcamp', 'chapter': 'Biostatistics > Risk_Quantification > Interpreting_Prevalence_and_Incidence'}, {'resource': 'Bootcamp', 'chapter': 'Biostatistics > Diagnostic_Tests > Sensitivity_and_Specificity'}, {'resource': 'Bootcamp', 'chapter': 'Immunology > Hypersensitivities > Type_III_Hypersensitivity_Reactions'}, {'resource': 'Bootcamp', 'chapter': 'Biostatistics > Bias_and_Study_Errors > Types_of_Study_Errors'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 08_Hypersensitivity_Reactions > 01_Type_1_Hypersensitivity_Reactions'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 08_Hypersensitivity_Reactions > 02_Type_2_Hypersensitivity_Reactions'}]},
    summary: `
...
`,
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Incidence (new cases) is unaffected by treatment of existing cases. However, since patients are living longer with the disease (increased duration) and not being cured, the pool of existing cases (Prevalence) increases. Prevalence = Incidence × Duration."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Positive Predictive Value (PPV) answers the question: 'Given a positive test result, what is the probability of having the disease?' Note that for rare diseases (low prevalence), PPV can be low even with high sensitivity/specificity."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Secondary prevention involves early detection of disease or precursors (screening). Colonoscopy detects polyps (precursors) or early cancer. Vaccination is Primary (prevention of onset). PT and Antibiotics are Tertiary (treatment/rehabilitation)."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Lead Time Bias occurs when screening detects disease earlier than clinical presentation, increasing the apparent 'survival time' (time from diagnosis to death) without actually changing the time of death or course of the disease."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "The denominator for incidence rate must only include the population **at risk**. Women who have had their ovaries removed (bilateral oophorectomy) are not at risk for ovarian cancer and must be excluded."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-28",
    ankingResource: {'primarySource': 'FirstAid', 'chapter': '06_Public_Health > 01_Epidemiology_&_Biostatistics > 10_Bias_&_Study_Errors', 'alternatives': [{'resource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 06_Bias'}, {'resource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 07_Bias'}, {'resource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 01_Study_Designs'}, {'resource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 02_Risk_Quantification'}, {'resource': 'B&B', 'chapter': '04_Biostatists/epi > 02_Epidemiology > 03_Sensitivity_&_Specificity'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 01_Cardiac_Pathology > 06_Myocardial_Infarction'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Fluid_&_Filtration_Physiology > Fluid_Physiology'}, {'resource': 'SketchyPath', 'chapter': '01_Cardiac > 01_Ischemic_Heart_Disease > 03_Acute_Myocardial_Infarction_&_Post-MI_Timeline'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Myocardial_Infarction > Post-Myocardial_Infarction_Timeline'}, {'resource': 'SketchyPharm', 'chapter': '06_Neuro/Psych > 05_Antipsychotics_&_Parkinsons > 01_First_generation_antipsychotics'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 02_Study_Designs'}, {'resource': 'Bootcamp', 'chapter': 'Nephrology > Fluid_&_Filtration_Physiology > Filtration_Physiology_Overview'}, {'resource': 'Bootcamp', 'chapter': 'Biostatistics > Risk_Quantification > Additional_Calculations_with_Relative_Risk'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Myocardial_Infarction > Myocardial_Infarction'}, {'resource': 'SketchyPharm', 'chapter': '05_GI_&_Endocrine > 04_Hypothalamic_&_Pituitary > 01_Growth_hormone,_mecasermin,_octreotide,_pegvisomant'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 07_Endocrine > 01_Insulin_Preparations'}, {'resource': 'SketchyPharm', 'chapter': '06_Neuro/Psych > 05_Antipsychotics_&_Parkinsons > 02_Second_generation_antipsychotics'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 05_Bias_&_Confounders'}, {'resource': 'Physeo', 'chapter': '04_Biostatistics > 01_Biostatistics > 09_Measurements_of_Risk'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 19_Respiratory > 1st_Generation_Antihistamines'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 07_Diabetes > Insulin_Preparations'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 19_Respiratory > 2nd-Generation_Antihistamines'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 12_MSK > Rasburicase'}, {'resource': 'Pixorize', 'chapter': '02_Biochem > 23_Diabetes_Drugs > 01_Insulin_Preparations'}]},
    summary: `
...
`,
    questions: [
      {
        ...
        correctAnswer: 2,
        rationale: "A cohort study is best for rare exposures. By recruiting workers exposed to asbestos (rare exposure) and following them over time, you can efficiently assess lung cancer incidence. A case-control study would be better for rare diseases, not rare exposures."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "An OR of 2.5 means MI patients are 2.5 times as likely to have been smokers compared to healthy controls. The 95% CI excludes 1, indicating statistical significance. OR > 1 indicates increased odds of exposure (smoking) in the diseased group."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Effect modification (interaction) occurs when an exposure behaves differently in different subgroups. Here, coffee's protective effect is much stronger in males (RR=0.4) than females (RR=0.9). If it were confounding, the RR would be similar in both strata after stratification."
      },
      {
        ...
        correctAnswer: 2,
        rationale: "RCTs use randomization to assign exposure, which minimizes selection bias and confounding by distributing known and unknown confounders equally between groups. RCTs are typically more expensive, not better for rare diseases, and study fewer exposures than cohort studies."
      },
      {
  ...
  },
  {
    ...
    createdAt: "2024-11-28",
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 02_Structures > 04_Brainstem', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 03_Spinal_Cord_&_Spinal_Tracts_-_Part_2'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 08_CNS_Tumors'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 03_Adult_CNS_Tumors'}, {'resource': 'Pathoma', 'chapter': '17_Neuro > 02_Spinal_Cord_Lesions'}, {'resource': 'FirstAid', 'chapter': '03_Microbiology > 04_Parasitology > 02_Protozoa_CNS_Infections'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 03_Spinal_Cord_&_Peripheral_Nerve > 01_Spinal_Muscular_Atrophy,_Amyotrophic_Lateral_Sclerosis_(ALS)_&_Friedreich_Ataxia'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 03_Spinal_Cord_&_Peripheral_Nerve > 02_Multiple_Sclerosis'}, {'resource': 'SketchyPath', 'chapter': '13_Neuro > 02_Intracranial_Hypertension_&_Tumors > 04_Pediatric_CNS_Tumors'}, {'resource': 'Physeo', 'chapter': '02_Anatomy > 02_Pulmonology > 01_Overview_of_Respiratory_Anatomy'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 13_Psychiatric > 06_CNS_Stimulants_Overview'}, {'resource': 'Physeo', 'chapter': '11_Pathology > 05_Neuropathology_Pathology > 06_Brain_Tumors'}, {'resource': 'SketchyPath', 'chapter': '07_Endocrine > 04_Thyroid_&_Parathyroid > 01_Hypothyroidism:_Overview_&_Hashimotos_Thyroiditis'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 05_GI > 01_Gastrointestinal_Overview'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 03_Pathology > 20_Adult_Primary_Brain_Tumors'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 40_Spinal_Tract_Anatomy_&_Functions'}, {'resource': 'Bootcamp', 'chapter': 'Neuroanatomy > Spinal_Cord_Tracts > Overview_of_Spinal_Cord_and_Spinal_tracts'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 20_Cerebellum'}, {'resource': 'FirstAid', 'chapter': '03_Microbiology > 04_Parasitology > 02_Protozoa_CNS_Infections > Toxoplasma_Gondii'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 02_Protozoa_of_the_CNS > 01_Toxoplasma_gondii'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > Hepatoduodenal_Ligament,_Celiac_Trunk,_Stomach,_Spleen,_Liver_&_Gallbladder > Clinical_-_Gallstones'}, {'resource': 'Bootcamp', 'chapter': 'Gross_Anatomy > External_Examination_of_the_Brain_+_Skull > Veins,_Venous_Sinuses,_and_Dural_Folds'}, {'resource': 'SketchyMicro', 'chapter': '03_Viruses > 01_RNA_(+)_Sense > 13_Flaviviridae_overview'}, {'resource': 'Bootcamp', 'chapter': 'Neuroanatomy > Spinal_Cord_Tracts > Two_neuron_chain_-_Stretch_Reflex_Arch'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Brainstem_Anatomy > Midbrain,_Pons,_and_Medulla'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 02_Spinal_Tracts > 01_Spinothalamic_Tract'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 02_Protozoa_of_the_CNS > 02_Trypanosoma_brucei'}, {'resource': 'SketchyMicro', 'chapter': '04_Parasites > 02_Protozoa_of_the_CNS > 03_Naegleria_fowleri'}, {'resource': 'SketchyMicro', 'chapter': '01_Bacteria > 10_Gram-indeterminate_Bacteria > 05_Rickettsia_overview'}, {'resource': 'Pixorize', 'chapter': '01_Immunology > 04_B_&_T_Cells > 03_B_Cells_-_Overview'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 07_Brain_Tumors > 01_Craniopharyngioma'}, {'resource': 'Pixorize', 'chapter': '05_Neuro > 02_Spinal_Tracts > 03_Dorsal_Column_(Medial_Lemniscus)'}, {'resource': 'SketchyPharm', 'chapter': '07_Antimicrobials > 05_Antifungals > 00_Overview'}]},
    summary: `
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "The primary motor cortex is located in the precentral gyrus. Motor pathways cross (decussate), so the left precentral gyrus controls the right side of the body. Damage to the left precentral gyrus would impair voluntary movement of the right hand."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Basal ganglia (also called basal nuclei) are located within the CNS (deep in the cerebral hemispheres), making them an exception to the rule that ganglia are PNS structures. Dorsal root ganglia and sympathetic ganglia are part of the PNS."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "The postcentral gyrus (posterior to the central sulcus) contains the primary somatosensory cortex, which receives sensory information from the body. Damage here would result in loss of sensation. Loss of voluntary movement would result from precentral gyrus (motor cortex) damage."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "The pons is the middle portion of the brainstem and has a characteristic large, bulging 'belly' appearance. It serves as a relay station and contains nuclei important for connecting the cerebrum and cerebellum."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "White matter consists of myelinated axons (the myelin's high fat content gives it a white appearance), while gray matter contains cell bodies and dendrites. White matter forms tracts that connect different brain regions."
      }
    ],
    glossary: [
...
`,
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Voltage-gated K<sup>+</sup> channels are responsible for repolarization during an action potential. Blocking them would prevent or delay K<sup>+</sup> efflux, prolonging the repolarization phase and extending the duration of the action potential."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "The resting membrane potential is determined primarily by the relative permeabilities to different ions. Since there are 40× more K<sup>+</sup> leak channels open at rest compared to Na<sup>+</sup> leak channels, the membrane is much more permeable to K<sup>+</sup>, pulling the RMP closer to E<sub>K</sub> (-80 mV)."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Lidocaine is a local anesthetic that blocks voltage-gated Na<sup>+</sup> channels in peripheral sensory neurons. This prevents action potential generation and propagation, blocking pain signals from reaching the CNS."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "During the absolute refractory period, voltage-gated Na<sup>+</sup> channels are in the inactivated state and cannot be opened regardless of stimulus strength. They must first return to the closed (resting) state before another action potential can be generated."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Jourenvax specifically targets Na<sub>V</sub>1.8 voltage-gated sodium channels, which are expressed in dorsal root ganglion (DRG) neurons but not in CNS neurons. This selectivity allows it to block peripheral pain signals without causing sensory or motor deficits from CNS Na<sup>+</sup> channel blockade."
      }
    ],
    glossary: [
  ...
  },
  {
    ...
    createdAt: "2024-11-28",
    ankingResource: {'primarySource': 'B&B', 'chapter': '15_Neuro > 04_ANS > 04_Autonomic_Receptors', 'alternatives': [{'resource': 'Physeo', 'chapter': '03_Physiology > 01_General_Principles > 03_Receptors_-_Part_1'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 01_General_Principles > 02_Receptors_&_Signaling_Pathways'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 01_Autonomic_Receptors'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Neurotransmitter_Activity_in_Psychiatric_Disease > Acetylcholine,_Dopamine,_Norepinephrine,_Serotonin,_and_GABA'}, {'resource': 'Physeo', 'chapter': '03_Physiology > 08_Neuro > 08_Basal_Ganglia_&_Dopaminergic_Pathways'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 14_Neuro > 03_Epilepsy_Carbamazepine,_Phenytoin,_Gabapentin,_Tiagabine'}, {'resource': 'SketchyPharm', 'chapter': '01_Autonomic_Drugs > 01_Parasympathetic > 02_Acetylcholinesterase_Inhibitors'}, {'resource': 'Physeo', 'chapter': '09_Pharm > 16_Autonomic_Pharm > 14_Dopamine_Histamine_Vasopressin_Receptors'}, {'resource': 'SketchyPharm', 'chapter': '06_Neuro/Psych > 04_Mood_Stabilizers_&_Antiepileptic_Drugs > 05_Carbamazepine,_phenytoin,_gabapentin,_tiagabine,_vigabatrin'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 01_General > D2_(Dopamine)_Receptors'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 01_Autonomic_Receptors > *Autonomic_Nervous_System'}, {'resource': 'Bootcamp', 'chapter': 'Cardiology > Pressure_and_Flow_Physiology > Sensory_Receptors_of_Vasculature'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 01_General > Alpha-1_(Adrenergic)_Receptors'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 02_Anatomy_&_Physiology > 08_Sensory_Receptors'}, {'resource': 'FirstAid', 'chapter': '05_Pharmacology > 02_Autonomic_Drugs > 02_Acetylcholine_Receptors'}, {'resource': 'FirstAid', 'chapter': '12_Neuro_&_Special_Senses > 06_Pharm > 12_Anesthetics_General_Principles'}, {'resource': 'Bootcamp', 'chapter': 'Histology > Skin > Sensory_Receptors'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia > 02_Carcinogenesis > 2_Oncogenes > Table_3.3_Important_Oncogenes > Growth_Factor_Receptors'}, {'resource': 'Bootcamp', 'chapter': 'Neurology > Neurotransmitter_Activity_in_Psychiatric_Disease > Dopaminergic_Pathways'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 13_Antiepileptics > Gabapentin'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 01_General > Alpha-2_(Adrenergic)_Receptors'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > Lolnotacop > 02_Carcinogenesis > 2_Oncogenes > Growth_Factor_Receptors'}, {'resource': 'Pixorize', 'chapter': '03_Pharm > 01_General > H1_(Histamine)_Receptors'}, {'resource': 'Bootcamp', 'chapter': 'Hematology_and_Oncology > Principles_of_Oncology_and_Therapeutics > Oncogenes_and_Tumor_Suppressor_Genes'}, {'resource': 'Pathoma', 'chapter': '03_Neoplasia_Alt_Tagging > BlueGalaxies > 02_Carcinogenesis > 2_Oncogenes > Growth_Factor_Receptors'}]},
    summary: `
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        rationale: "Acetylcholinesterase inhibitors block the enzyme that breaks down acetylcholine (ACh &rarr; Acetate + Choline). By preventing degradation, more ACh remains in the synapse, prolonging its action. This helps compensate for the loss of cholinergic neurons in Alzheimer's disease."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "NMDA receptors require THREE conditions to open: (1) glutamate (or aspartate) binding, (2) glycine or D-serine (co-ligand) binding, and (3) depolarization to remove the Mg<sup>2+</sup> block. This means they only activate when the postsynaptic neuron receives both the neurotransmitter signal AND is already somewhat depolarized, detecting coincident signals critical for synaptic plasticity."
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 2,
        rationale: "Huntington's disease causes loss of GABAergic neurons in the striatum. Since GABA is inhibitory, loss of these neurons reduces inhibitory signaling in movement control circuits, leading to uncontrollable movements (chorea). These striatal neurons also express dopamine receptors."
      },
      {
        ...
        correctAnswer: 1,
        rationale: "Benzodiazepines enhance the activity of GABA<sub>A</sub> receptors, which are Cl<sup>-</sup> channels. By potentiating GABA<sub>A</sub> receptor activity, benzodiazepines increase inhibitory signaling throughout the brain, producing anxiolytic (anti-anxiety), sedative, and muscle relaxant effects."
      }
    ],
    glossary: [
